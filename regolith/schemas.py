...
SCHEMAS = {'abstracts': {'_description': {'description': 'Abstracts for a conference or workshop. This is generally public information\n\n'},
  '_id': {'description': 'Unique identifier for submission. This generally includes the author name and part of the title.',
   'required': True,
   'type': 'string'},
  ...
  'lastname': {'description': 'last name of the author.',
   'required': True,
   'type': 'string'},
  'references': {'description': 'HTML string of reference for the abstract itself',
   'required': False,
   'type': 'string'},
  'text': {'description': 'HTML string of the abstract.',
   'required': True,
   'type': 'string'},
  'timestamp': {'description': 'The time when the abstract was submitted.',
   'required': True,
   'type': 'string'},
  'title': {'description': 'title of the presentation/paper.',
   'required': True,
   'type': 'string'}},
 'assignments': {'_description': {'description': 'Information about assignments for classes.\n\n'},
  '_id': {'description': 'A unique id for the assignment, such a HW01-EMCH-558-2016-S',
   'required': True,
   'type': 'string'},
  'category': {'description': "such as 'homework' or 'final'",
   'required': True,
   'type': 'string'},
  'courses': {'description': 'ids of the courses that have this assignment',
   'required': True,
   'type': 'string'},
  'file': {'description': 'path to assignment file in store',
   'required': False,
   'type': 'string'},
  'points': {'description': 'list of number of points possible for each question. Length is the number of questions',
   'required': True,
   'type': ('integer', 'float')},
  'question': {'description': 'titles for the questions on this assignment',
   'required': False,
   'type': 'string'},
  'solution': {'description': 'path to solution file in store',
   'required': False,
   'type': 'string'}},
 'blog': {'_description': {'description': 'This collection represents blog posts written by the members of the research group.\n\n'},
  ...
  'month': {'description': 'Publication month',
   'required': True,
   'type': 'string'},
  'original': {'description': 'URL of original post, if this is a repost',
   'required': False,
   'type': 'string'},
  ...
  'year': {'description': 'Publication year',
   'required': True,
   'type': 'integer'}},
 'grades': {'_description': {'description': 'The grade for a student on an assignment. This information should be private.\n\n'},
  '_id': {'description': 'unique id, typically the student-assignment-course',
   'required': True,
   'type': 'string'},
  ...
  'filename': {'description': 'path to file in store',
   'required': False,
   'type': 'string'},
  'scores': {'description': 'the number of points earned on each question',
   'required': True,
   'type': ('integer', 'float')},
  'student': {'description': 'student id',
   'required': True,
   'type': 'string'}},
 'grants': {'_description': {'description': 'This collection represents grants that have been awarded to the group.\n\n'},
  ...
  'status': {'allowed': ['pending', 'declined', 'accepted', 'in-prep'],
   ...
   'required': True,
   'type': 'string'},
  'team': {'description': 'information about the team members participating in the grant.',
   'required': True,
   'schema': {'schema': {'cv': {'required': False, 'type': 'string'},
     'institution': {'required': True, 'type': 'string'},
     'name': {'required': True, 'type': 'string'},
     'position': {'required': True, 'type': 'string'},
     'subaward_amount': {'required': False, 'type': ('integer', 'float')}},
    'type': 'dict'},
   'type': 'list'},
  'title': {'description': 'actual title of proposal / grant',
   'required': True,
   'type': 'string'}},
 'people': {'_description': {'description': 'This collection describes the members of the research group.  This is normally public\ndata.\n\n'},
  '_id': {'description': 'unique identifier for the group member',
   'required': True,
   'type': 'string'},
  'active': {'description': 'If the person is an active member, default True.',
   'required': False,
   'type': 'boolean'},
  'aka': {'description': 'list of aliases (also-known-as), useful for identifying the group member in citations or elsewhere.',
   'required': True,
   'type': ['string', 'list']},
  ...
  'bio': {'description': 'short biographical text',
   'required': True,
   'type': 'string'},
  'collab': {'description': 'If the person is a collaborator, default False.',
   'required': False,
   'type': 'boolean'},
  'education': {'description': 'This contains the educational information for the group member.',
   'required': True,
  ...
  'email': {'description': 'email address of the group member',
   'required': False,
   'type': 'string'},
  'employment': {'description': 'Employment information, similar to educational information.',
   'required': True,
   'schema': {'begin_month': {'required': False, 'type': 'string'},
    'begin_year': {'required': True, 'type': 'integer'},
    'end_month': {'required': False, 'type': 'string'},
    ...
    'position': {'required': True, 'type': 'string'}},
   'type': 'list'},
  'funding': {'description': 'Funding and scholarship that the group member has individually obtained in the past. **WARNING:** this is not to be confused with the **grants** collection',
   'required': False,
   ...
   'type': 'list'},
  'honors': {'description': 'Honors that have been awarded to this group member',
   'required': False,
   'schema': {'description': {'required': False, 'type': 'string'},
    ...
    'year': {'required': True, 'type': 'integer'}},
   'type': 'list'},
  'membership': {'description': 'Profesional organizations this member is a part of',
   'required': False,
   'schema': {'begin_month': {'required': False, 'type': 'string'},
    'begin_year': {'required': True, 'type': 'integer'},
  ...
  'name': {'description': 'Full, canonical name for the person',
   'required': True,
   'type': 'string'},
  'position': {'description': 'such as professor, graduate student, or scientist',
   'required': True,
   'type': 'string'},
  'service': {'description': 'Service that this group member has provided',
   'required': False,
   'schema': {'description': {'required': False, 'type': 'string'},
    'duration': {'required': False, 'type': 'string'},
    'month': {'required': False, 'type': 'string'},
  ...
  'skills': {'description': 'Skill the group member has',
   ...
   'schema': {'category': {'required': True, 'type': 'string'},
    ...
    'name': {'required': True, 'type': 'string'}},
   'type': 'list'},
  'teaching': {'description': 'Courses that this group member has taught, if any',
   'required': False,
  ...
  'title': {'description': 'for example, Dr., etc.',
   'required': False,
   'type': 'string'}},
 'projects': {'_description': {'description': 'This collection describes the research group projects. This is normally public data.\n\n'},
  ...
  'description': {'description': 'brief project description.',
   'required': True,
   'type': 'string'},
  'grant': {'description': 'Grant id if there is a grant supporting this project',
   'type': 'string'},
  ...
  'repo': {'description': 'URL of the source code repo, if available',
   'required': False,
   'type': 'string'},
  'team': {'description': 'People who are/have been woking on this project.',
   'required': True,
   'schema': {'begin_month': {'required': False, 'type': 'string'},
    'begin_year': {'required': True, 'type': 'integer'},
    'end_month': {'required': False, 'type': 'string'},
  ...
  'website': {'description': 'URL of the website.',
   'required': True,
   'type': 'string'}},
 'proposals': {'_description': {'description': 'This collection represents proposals that have been submitted by the group.\n\n'},
  ...
  'year': {'description': 'Year that the proposal is due',
   'required': True,
   'type': 'integer'}},
 'students': {'_description': {'description': 'This is a collection of student names and metadata. This should probably be private.\n\n'},
  '_id': {'description': 'short represntation, such as this-is-my-name',
   'required': True,
   'type': 'string'},
  ...
  'email': {'description': 'email address',
   'required': False,
   'type': 'string'},
  'university_id': {'description': 'The university identifier for the student',
   'required': False,
   'type': 'string'}}}
