...
SCHEMAS = {
    ...
    "reading_lists": {
        "_description": {
            "description": "This is a collection that will be used to build a reading list."
        },
        "_id": {
            "description": "A short name of the reading list. It will also be the name of the generated txt file. ",
            "required": True,
            "type": "string",
        },
        "day": {
            "description": "day when the reading list is created",
            "required": False,
            "type": "integer",
        },
        "month": {
            "description": "month when the reading list is created",
            "required": False,
            "type": "integer",
        },
        "year": {
            "description": "year when the reading list is created",
            "required": False,
            "type": "integer",
        },
        "papers": {
            "description": "list of papers and websites",
            "required": True,
            "type": "list",
            "schema": {
                "type": "dict",
                "schema": {
                    "doi": {"description": "doi of the paper",
                            "required": False,
                            "type": "string"},
                    "url": {"description": "url of the web page",
                            "required": False,
                            "type": "string"},
                    "text": {"description": "notes about this paper/web page ",
                             "required": False,
                             "type": "string"},
                }
            }
        ...
        "purpose": {
            "description": "The purpose or intended use for the reading ",
            "required": False,
            "type": "string",
        },
        "title": {
            "description": "Title for the list that will be rendered with the list",
            "required": True,
            "type": "string",
        },
    },
