...
SCHEMAS = {
    'abstracts': {
        ...
        'firstname': {'description': 'first name of the author.',
                      'required': True,
                      'type': 'string'},
        'institution': {'description': 'name of the institution',
                        'required': True,
                        'type': 'string'},
    ...
    'grants': {
        ...
        'account': {'description': 'account number for awarded grants',
                    'required': False,
                    'type': ('integer', 'float', 'string')},
        'amount': {'description': 'value of award for research group',
                   'required': True,
                   'type': ('integer', 'float')},
        ...
        'funder': {'description': 'the agency funding the work',
                   'required': True,
                   'type': 'string'},
        'institution': {'description': 'institution which holds the account',
                        'required': True,
                        'type': 'string'},
        'narrative': {'description': '', 'required': False, 'type': 'string'},
        'person_months_academic': {'description': 'number of person months'
                                                  'funded during the academic'
                                                  'year',
                                   'required': False,
                                   'type': ('integer', 'float')},
        'person_months_summer': {'description': 'number of person months'
                                                'funded during the summer',
                                 'required': False,
                                 'type': ('integer', 'float')},
        'program': {'description': 'the program the work was funded under',
                    'required': True,
                    'type': 'string'},
        'scope': {'description': 'grant scope',
                  'required': False,
                  'type': 'string'},
        'short_title': {'description': 'short title for grant',
                        'required': False,
                        'type': 'string'},
        'team': {
        ...
        'title': {'description': 'actual title of proposal / grant',
                  'required': True,
                  'type': 'string'},
        'total_amount': {'description': 'total value of award',
                         'required': True,
                         'type': ('integer', 'float')},
    },
    'people': {
        ...
        'funding': {
            'description': 'Funding and scholarship that the group member '
                           ...
                           '**grants** collection',
            'required': False,
            'schema': {'currency': {'required': False, 'type': 'string'},
        ...
        'honors': {
            'description': 'Honors that have been awarded to this '
                           'group member',
            'required': False,
            'schema': {'description': {'required': False, 'type': 'string'},
                       'month': {'required': False, 'type': 'string'},
                       'name': {'required': True, 'type': 'string'},
                       'year': {'required': True, 'type': 'integer'}},
            'type': 'list'},
        ...
        'skills': {'description': 'Skill the group member has',
                   'required': False,
                   'schema': {'category': {'required': True, 'type': 'string'},
    ...
    'proposals': {
        ...
        '_id': {'description': 'short representation, such as this-is-my-name',
                'required': True,
                'type': ('string', 'integer', 'float')},
        'amount': {'description': 'value requested',
                   'required': True,
                   'type': ('integer', 'float')},
        ...
        'currency': {'description': "typically '$' or 'USD'",
                     'required': True,
                     'type': 'string'},
        'due_day': {'description': 'due day of the proposal',
                    'required': True,
                    'type': ('string', 'integer')},
        'due_month': {'description': 'due month of the proposal',
                      'required': True,
                      'type': 'string'},
        'due_year': {'description': 'due year of the proposal',
                     'required': True,
                     'type': 'integer'},
        'duration': {'description': 'number of years',
                     'required': True,
                     'type': ('integer', 'float')},
        # TODO: this is required if awarded
        ...
        'status': {'description': "e.g. 'submitted', 'accepted', 'rejected'",
                   'required': True,
                   'type': 'string'},
        'submission_day': {'description': 'submission day of the proposal',
                           'required': False,
                           'type': ('string', 'integer')},
        'submission_month"': {
            'description': 'submission month of the proposal',
            'required': False,
            'type': 'string'},
        'submission_year': {'description': 'submission year of the proposal',
                            'required': False,
                            'type': 'integer'},
        'title': {'description': 'actual title of proposal',
                  'required': True,
                  'type': 'string'},
        'total_amount': {'description': 'requested amount',
                         'required': True,
                         'type': ('integer', 'float')},
        'full': {'description': 'full proposal',
                 'required': False,
                 'type': 'dict',
                 'schema': {'benefit_of_collaboration': {'type': 'string'},
                            'cv': {'type': 'list'},
