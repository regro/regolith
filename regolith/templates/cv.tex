      ...
      {% if 'narrative' in grant or 'benefit_of_collaboration' in grant or 'call_for_proposals' in grant %}
        \resitem{
          {%- if 'narrative' in grant %}
            \href{ {{-latex_safe(grant['narrative'], url_check=False)-}} }{Narrative}.
          {%- endif %}
          {%- if 'benefit_of_collaboration' in grant %}
            \href{ {{-latex_safe(grant['benefit_of_collaboration'], url_check=False)-}} }{Benefit of Collaboration}.
          {%- endif %}
          {%- if 'call_for_proposals' in grant %}
            \href{ {{-latex_safe(grant['call_for_proposals'], url_check=False)-}} }{Call for Proposals}.
          {%- endif %}
        }
      {% endif %}
    }
...
\ressubheadingitems{ {{-t['course']-}} }
    ...
    { {% if 'description' in t %}
      ...
      {% if 'website' in t or 'syllabus' in t or 'video' in t or 'materials' in t %}
        \resitem{
          {%- if 'website' in t %}
            \href{ {{-latex_safe(t['website'], url_check=False)-}} }{Website}.
          {%- endif %}
          {%- if 'syllabus' in t %}
            \href{ {{-latex_safe(t['syllabus'], url_check=False)-}} }{Syllabus}.
          {%- endif %}
          {%- if 'video' in t %}
            \href{ {{-latex_safe(t['video'], url_check=False)-}} }{Video}.
          {%- endif %}
          {%- if 'materials' in t %}
            \href{ {{-latex_safe(t['materials'], url_check=False)-}} }{Source Materials}.
          {%- endif %}
        }
      {% endif %}
    }
