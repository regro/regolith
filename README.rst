...
.. _title: https://regro.github.io/regolith/regolith-docs/
...
Regolith has three main functions, adder, updater, and listers. People could use these
three functions to schedule todos, presentation, funding, grants, etc.
