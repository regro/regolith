...
# abbreviations
ab_authors = "Anthony Scopatz, Simon Billinge, Billinge Group members and community contributors"
...
project = "regolith"
copyright = (
    "2015-2017 Anthony Scopatz, 2018-%Y The Trustees of Columbia University in the City of New York,"
    " %Y regolith contributors"
)
