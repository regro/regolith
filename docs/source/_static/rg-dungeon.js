...
var xsize = 61;
var ysize = 61;
var pl = { x: 2*xsize-1, y: ysize }; // Player position
...
function mazegen(x,y) {
    ...
    var fmxlen= rgmap[0].length;
    var fmylen= rgmap.length;
...
// Initialize sotuff
function initRgDungeon() {
	window.setInterval(tick, 50); // Animation
	// Initialize Viewport, i.e. the place where the characters are displayed
    term = new ut.Viewport(document.getElementById("game"), 78, 18);
