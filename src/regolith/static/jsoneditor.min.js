  ...
  return (function (e) {
      ...
      (n.modes = {}),
        ...
        (n.prototype.setMode = function (e) {
          ...
          try {
            ...
            if (
              ((i = this.getName()),
              (t = this[l ? "getText" : "get"]()),
              this._delete(),
              s.clear(this),
              s.extend(this, a.mixin),
              this.create(o, r),
              this.setName(i),
              this[l ? "setText" : "set"](t),
        ...
        (n.prototype._onError = function (e) {
          if (
            ("function" == typeof this.onError &&
              (s.log(
                "WARNING: JSONEditor.onError is deprecated. Use options.error instead.",
              ),
              this.onError(e)),
            !this.options || "function" != typeof this.options.error)
          )
            throw e;
        ...
        (n.registerMode = function (e) {
          var t, i;
          if (s.isArray(e)) for (t = 0; t < e.length; t++) n.registerMode(e[t]);
          else {
            ...
            for (t = 0; t < r.length; t++)
              if (((i = r[t]), i in e.mixin))
                throw new Error(
                  'Reserved property "' + i + '" not allowed in mixin',
                );
            n.modes[o] = e;
          }
        }),
    ...
    function (e, t, i) {
      ...
      (c.set = function (e, t) {
        if (
          (t &&
            (l.log(
              'Warning: second parameter "name" is deprecated. Use setName(name) instead.',
            ),
            (this.options.name = t)),
          ...
          var i = { field: this.options.name, value: e },
            n = new s(this, i);
          this._setRoot(n);
          var o = !1;
          ...
          e
            ...
            : this.node.dom.expand
              ...
              : this.node.dom.menu
                ...
                : ((e = this.frame.querySelector("button")), e && e.focus());
        }),
        (c.clear = function () {
          this.node &&
            (this.node.collapse(),
        ...
        (c.startAutoScroll = function (e) {
          var t = this,
            ...
            a = 50;
          n + s > e && i.scrollTop > 0
            ? (this.autoScrollStep = (n + s - e) / 3)
            : e > r - s && o + i.scrollTop < i.scrollHeight
        ...
        (c.setSelection = function (e) {
          e &&
            ...
            e.range && l.setSelectionOffset(e.range),
            e.dom && e.dom.focus());
        }),
        ...
        (c.scrollTo = function (e, t) {
          ...
          if (i) {
            var n = this;
            n.animateTimeout &&
              (clearTimeout(n.animateTimeout), delete n.animateTimeout),
              n.animateCallback &&
                (n.animateCallback(!1), delete n.animateCallback);
            var o = i.clientHeight,
              ...
              a = function () {
                ...
                Math.abs(o) > 3
                  ? ((i.scrollTop += o / 3),
                    (n.animateCallback = t),
                    (n.animateTimeout = setTimeout(a, 50)))
                  : (t && t(!0),
                    (i.scrollTop = s),
        ...
        (c._createFrame = function () {
          ...
          (this.frame.onclick = function (t) {
            ...
            l.addEventListener(this.frame, "focus", e, !0),
            l.addEventListener(this.frame, "blur", e, !0),
          ...
          if (
            ((n.title = "Collapse all fields"),
            (n.className = "collapse-all"),
            (n.onclick = function () {
              t.collapseAll();
            }),
        ...
        (c._onUndo = function () {
          this.history &&
            (this.history.undo(), this.options.change && this.options.change());
        }),
        (c._onRedo = function () {
          this.history &&
    ...
    function (e, t, i) {
      ...
      (a.create = function (e, t) {
        ...
        (a._onKeyDown = function (e) {
          ...
          220 == t &&
            e.ctrlKey &&
            (e.shiftKey ? this.compact() : this.format(), (i = !0)),
    ...
    function (e, t, i) {
      ...
      (t.isUrl = function (e) {
        ...
        (t.getInnerText = function (e, i) {
          ...
          if (e.hasChildNodes()) {
            for (
              var o = e.childNodes, r = "", s = 0, a = o.length;
              a > s;
              s++
            ) {
              var l = o[s];
          ...
          return "P" == e.nodeName && -1 != t.getInternetExplorerVersion()
            ? i.flush()
            : "";
        }),
      ...
      (t.addEventListener = function (e, i, n, o) {
        ...
        (t.removeEventListener = function (e, i, n, o) {
          e.removeEventListener
            ...
            : e.detachEvent && e.detachEvent("on" + i, n);
        });
    },
    function (e, t, i) {
      function n() {
              ...
              t && t.undo
                ? (t.undo(e.params),
                  e.params.oldSelection &&
                    this.editor.setSelection(e.params.oldSelection))
                : o.log('Error: unknown action "' + e.action + '"');
            }
              ...
              t && t.redo
                ? (t.redo(e.params),
                  e.params.newSelection &&
                    this.editor.setSelection(e.params.newSelection))
                : o.log('Error: unknown action "' + e.action + '"');
            }
            this.onChange();
          }
      ...
      (n.prototype.next = function (e) {
        ...
        (n.prototype._setActiveResult = function (e, t) {
          if (this.activeResult) {
            ...
            "field" == n
              ? delete i.searchFieldActive
              : delete i.searchValueActive,
              i.updateDom();
          }
    ...
    function (e, t, i) {
      ...
      (n.prototype._updateEditability = function () {
        if (
          ...
          this.editor &&
            ...
            "tree" === this.editor.options.mode &&
              "function" == typeof this.editor.options.editable))
        ) {
          ...
          "boolean" == typeof e
            ? ((this.editable.field = e), (this.editable.value = e))
            : ("boolean" == typeof e.field && (this.editable.field = e.field),
          ...
          if ("array" == this.type) {
            ...
            for (var s = 0, a = e.length; a > s; s++)
              (i = e[s]),
                void 0 === i ||
                  ...
                  ((o = new n(this.editor, { value: i })), this.appendChild(o));
            this.value = "";
            ...
            for (var l in e)
              e.hasOwnProperty(l) &&
                ...
                void 0 === i ||
                  i instanceof Function ||
                  ((o = new n(this.editor, { field: l, value: i })),
                  this.appendChild(o)));
            this.value = "";
        ...
        (n.prototype.expand = function (e) {
          this.childs &&
            ((this.expanded = !0),
            this.dom.expand && (this.dom.expand.className = "expanded"),
            this.showChilds(),
            e !== !1 &&
              this.childs.forEach(function (t) {
                t.expand(e);
        ...
        (n.prototype.collapse = function (e) {
          this.childs &&
            ...
            this.dom.expand && (this.dom.expand.className = "collapsed"),
            (this.expanded = !1));
        }),
              ...
              case "expand":
                this._hasChilds()
                  ...
                  : t.field && this.fieldEditable
                    ? (t.field.focus(), s.selectContentEditable(t.field))
                    : t.value && !this._hasChilds()
                      ? (t.value.focus(), s.selectContentEditable(t.value))
                      : t.menu.focus();
                break;
              case "field":
                t.field && this.fieldEditable
        ...
        (n.prototype.changeType = function (e) {
          ...
          if (t != e) {
            if (
              ...
              var i,
                n = this.dom.tr ? this.dom.tr.parentNode : void 0;
              ...
              this.hide(),
                ...
                "object" == e
                  ? (this.childs || (this.childs = []),
                    ...
                    ("string" == t || "auto" == t) && (this.expanded = !0))
                  : "array" == e
                    ? (this.childs || (this.childs = []),
                      this.childs.forEach(function (e, t) {
                ...
                n &&
                  (o
                    ? n.insertBefore(this.getDom(), o)
                    : n.appendChild(this.getDom())),
                this.showChilds();
            } else this.type = e;
            ("auto" == e || "string" == e) &&
              ("string" == e
        ...
        (n.prototype._getDomValue = function (e) {
          if (
            (this.dom.value &&
              "array" != this.type &&
              "object" != this.type &&
              (this.valueInnerText = s.getInnerText(this.dom.value)),
        ...
        (n.prototype._updateDomValue = function () {
          ...
          if (e) {
            ...
            var r =
              ...
              "object" != this.type;
            if (
              (r ? s.addClassName(e, "empty") : s.removeClassName(e, "empty"),
              n ? s.addClassName(e, "url") : s.removeClassName(e, "url"),
              "array" == i || "object" == i)
            ) {
            ...
            this.searchValueActive
              ? s.addClassName(e, "highlight-active")
              : s.removeClassName(e, "highlight-active"),
              this.searchValue
                ? s.addClassName(e, "highlight")
                : s.removeClassName(e, "highlight"),
              s.stripFormatting(e);
          }
        }),
        (n.prototype._updateDomField = function () {
          ...
          if (e) {
            ...
            t ? s.addClassName(e, "empty") : s.removeClassName(e, "empty"),
        ...
        (n.prototype._getDomField = function (e) {
          if (
            (this.dom.field &&
              this.fieldEditable &&
              (this.fieldInnerText = s.getInnerText(this.dom.field)),
        ...
        (n.prototype._onDragStart = function (e) {
          var t = this;
          this.mousemove ||
            (this.mousemove = s.addEventListener(
              document,
              "mousemove",
              function (e) {
                t._onDrag(e);
            ...
            this.mouseup ||
              (this.mouseup = s.addEventListener(
                document,
                "mouseup",
                function (e) {
                  t._onDragEnd(e);
        ...
        (n.prototype._onDrag = function (e) {
          ...
          if (
            ...
            do
              (i = i.previousSibling),
                (h = n.getNodeFromTarget(i)),
                (g = i ? s.getAbsoluteTop(i) : 0);
            while (i && g > A);
            h && !h.parent && (h = void 0),
              h ||
                ((c = t.parentNode.firstChild),
                (i = c ? c.nextSibling : void 0),
                (h = n.getNodeFromTarget(i)),
                h == this && (h = void 0)),
              h &&
                ((i = h.dom.tr),
                (g = i ? s.getAbsoluteTop(i) : 0),
                A > g + p && (h = void 0)),
              h && (h.parent.moveBefore(this, h), (C = !0));
          } else if (
            ((l =
              this.expanded && this.append
                ? this.append.getDom()
                : this.dom.tr),
            (r = l ? l.nextSibling : void 0))
          ) {
            (f = s.getAbsoluteTop(r)), (o = r);
            do
              (u = n.getNodeFromTarget(o)),
                o &&
                  ((m = o.nextSibling ? s.getAbsoluteTop(o.nextSibling) : 0),
                  (v = o ? m - f : 0),
                  1 == u.parent.childs.length &&
                    u.parent.childs[0] == this &&
                    (d += 23)),
                (o = o.nextSibling);
            while (o && A > d + v);
            if (u && u.parent) {
              var E = w - this.drag.mouseX,
                F = Math.round(E / 24 / 2),
                y = this.drag.level + F,
                b = u.getLevel();
              ...
              l.nextSibling != u.dom.tr &&
                (u.parent.moveBefore(this, u), (C = !0));
            }
          }
          C && ((this.drag.mouseX = w), (this.drag.level = this.getLevel())),
            this.editor.startAutoScroll(A),
            e.preventDefault();
        }),
        (n.prototype._onDragEnd = function (e) {
          ...
          (t.startParent != t.endParent || t.startIndex != t.endIndex) &&
            this.editor._onAction("moveNode", t),
            (document.body.style.cursor = this.drag.oldCursor),
            this.editor.highlighter.unlock(),
            delete this.drag,
            this.mousemove &&
              (s.removeEventListener(document, "mousemove", this.mousemove),
              delete this.mousemove),
            this.mouseup &&
              (s.removeEventListener(document, "mouseup", this.mouseup),
              delete this.mouseup),
        ...
        (n.prototype.updateDom = function (e) {
          ...
          if (o) {
            ...
            "array" == this.type
              ...
              : "object" == this.type
                ? (o.innerHTML = "{" + r + "}")
                : (o.innerHTML = this._escapeHTML(this.value));
          }
          this._updateDomField(),
            this._updateDomValue(),
            ...
            ("array" == this.type
              ...
              : "object" == this.type &&
                t.forEach(function (e) {
                  void 0 != e.index &&
                    (delete e.index, void 0 == e.field && (e.field = ""));
                }));
        }),
            ...
            "array" == this.type
              ...
              : "object" == this.type
                ? ((e = document.createElement("div")),
                  (e.className = "readonly"),
                  (e.innerHTML = "{...}"))
                : !this.editable.value && s.isUrl(this.value)
          ...
          if (
            ((n == o.drag || n == o.menu) &&
              ("mouseover" == i
                ...
                : "mouseout" == i && this.editor.highlighter.unhighlight()),
            "mousedown" == i && n == o.drag && this._onDragStart(e),
            "click" == i && n == o.menu)
          ) {
            var l = r.editor.highlighter;
            l.highlight(r),
              l.lock(),
              s.addClassName(o.menu, "selected"),
              this.showContextMenu(o.menu, function () {
                s.removeClassName(o.menu, "selected"),
                  l.unlock(),
                  l.unhighlight();
              });
          }
          ...
          if (n == u)
            switch (i) {
              ...
              case "change":
                this._getDomField(!0),
                  this._updateDomField(),
                  this.field && (u.innerHTML = this._escapeHTML(this.field));
                break;
              case "input":
              ...
              case "click":
                var g =
                  void 0 != e.offsetX
                    ...
                    : e.pageX < s.getAbsoluteLeft(o.tdSeparator);
                g || a
                  ? u && (s.setEndOfContentEditable(u), u.focus())
                  : h && (s.setEndOfContentEditable(h), h.focus());
            }
          if ((n == o.tdExpand && !a) || n == o.tdField || n == o.tdSeparator)
            switch (i) {
              case "click":
                u && (s.setEndOfContentEditable(u), u.focus());
            }
        ...
        (n.prototype.onKeyDown = function (e) {
          ...
          if (13 == l) {
            ...
            if (d && !u) {
              ...
              o &&
                ((i = n.getNodeFromTarget(o)),
                (r = o.nextSibling),
                (b = n.getNodeFromTarget(r)),
                i &&
                  i instanceof a &&
                  1 != this.parent.childs.length &&
                  b &&
                  b.parent &&
                  (b.parent.moveBefore(this, b),
                  this.focus(n.focusElement || this._getElementName(c))));
            }
          } else if (38 == l)
            d && !u
              ? ((t = this._previousNode()),
                t && t.focus(n.focusElement || this._getElementName(c)),
                (g = !0))
              : d &&
                u &&
                ((t = this._previousNode()),
            ...
            if (d && !u)
              (i = this._nextNode()),
                i && i.focus(n.focusElement || this._getElementName(c)),
                (g = !0);
            else if (d && u && f) {
              (i = this.expanded
                ? this.append
                  ? this.append._nextNode()
                  : void 0
                : this._nextNode()),
                (o = i ? i.getDom() : void 0),
                (r =
        ...
        (n.prototype._onExpand = function (e) {
          ...
          this.expanded ? this.collapse(e) : this.expand(e),
            e && (i.appendChild(t), (i.scrollTop = n));
        }),
        ...
        (n.prototype.getAppend = function () {
          return (
            this.append ||
              ((this.append = new a(this.editor)), this.append.setParent(this)),
            this.append.getDom()
          );
        }),
        ...
        (n.prototype._previousNode = function () {
          ...
          if (t && t.parentNode) {
            var i = t;
            do (i = i.previousSibling), (e = n.getNodeFromTarget(i));
        ...
        (n.prototype._nextNode = function () {
          ...
          if (t && t.parentNode) {
            var i = t;
            do (i = i.nextSibling), (e = n.getNodeFromTarget(i));
            while (i && e instanceof a && !e.isVisible());
          }
          return e;
        }),
                ...
                submenu: [
                  {
                    text: "Auto",
                    className:
                      "type-auto" + ("auto" == this.type ? " selected" : ""),
                    title: r.auto,
                    click: function () {
                  ...
                  },
                  {
                    text: "Array",
                    className:
                      "type-array" + ("array" == this.type ? " selected" : ""),
                    title: r.array,
                    click: function () {
        ...
        (n.prototype._getType = function (e) {
          return e instanceof Array
            ...
            : e instanceof Object
              ? "object"
              : "string" == typeof e && "string" != typeof this._stringCast(e)
                ? "string"
                : "auto";
        }),
    ...
    function (e, t, i) {
      function n(e, t, i) {
        ...
        return (
          (d.className = "modes separator"),
          (d.innerHTML = u + " &#x25BE;"),
          (d.title = "Switch editor mode"),
          (d.onclick = function () {
            var e = new o(s);
            e.show(d);
          }),
    ...
    function (e, t, i) {
            ...
            if ("separator" == o.type) {
              ...
              if (
                ...
                if (o.click) {
                  ...
                  (s.buttonExpand = u),
                    (u.className = "expand"),
                    (u.innerHTML = '<div class="expand"></div>'),
                    a.appendChild(u),
                    o.submenuTitle && (u.title = o.submenuTitle),
                    (h = u);
                } else {
      ...
      (n.prototype._getVisibleButtons = function () {
        var e = [],
          t = this;
        return (
          this.dom.items.forEach(function (i) {
            e.push(i.button),
              i.buttonExpand && e.push(i.buttonExpand),
              i.subItems &&
                i == t.expandedItem &&
                i.subItems.forEach(function (t) {
        ...
        (n.prototype.show = function (e) {
          ...
          r > c + s + a
            ? ((this.dom.menu.style.left = l + "px"),
              (this.dom.menu.style.top = c + s + "px"),
              (this.dom.menu.style.bottom = ""))
            : ((this.dom.menu.style.left = l + "px"),
              (this.dom.menu.style.top = ""),
              (this.dom.menu.style.bottom = t - c + "px")),
            document.body.appendChild(this.dom.menu);
          var h = this,
            u = this.dom.list;
          (this.eventListeners.mousedown = o.addEventListener(
            document,
            "mousedown",
            function (e) {
              var t = e.target;
              t == u ||
                h._isChildOf(t, u) ||
                (h.hide(), e.stopPropagation(), e.preventDefault());
            },
          )),
            (this.eventListeners.mousewheel = o.addEventListener(
              document,
              "mousewheel",
              function (e) {
            ...
            (this.eventListeners.keydown = o.addEventListener(
              document,
              "keydown",
              function (e) {
                h._onKeyDown(e);
        ...
        (n.prototype.hide = function () {
          ...
          for (var e in this.eventListeners)
            if (this.eventListeners.hasOwnProperty(e)) {
              ...
              t && o.removeEventListener(document, e, t),
          ...
          if (
            (n &&
              ...
              setTimeout(function () {
                t.expandedItem != n &&
                  ((n.ul.style.display = ""),
                  o.removeClassName(n.ul.parentNode, "selected"));
              }, 300),
            ...
            setTimeout(function () {
              t.expandedItem == e &&
                ((r.style.height = 24 * r.childNodes.length + "px"),
                (r.style.padding = "5px 10px"));
            }, 0),
              o.addClassName(r.parentNode, "selected"),
              (this.expandedItem = e);
          }
        }),
        (n.prototype._onKeyDown = function (e) {
          var t,
            ...
            l = !1;
          27 == a
            ? (this.selection && o.setSelection(this.selection),
            ...
            : 9 == a
              ? e.shiftKey
                ? ((t = this._getVisibleButtons()),
                  (i = t.indexOf(s)),
                  0 == i && (t[t.length - 1].focus(), (l = !0)))
                : ((t = this._getVisibleButtons()),
                  (i = t.indexOf(s)),
                  i == t.length - 1 && (t[0].focus(), (l = !0)))
              : 37 == a
                ? ("expand" == s.className &&
                    ((t = this._getVisibleButtons()),
                    (i = t.indexOf(s)),
                ...
                : 38 == a
                  ...
                  : 39 == a
                    ? ((t = this._getVisibleButtons()),
                      (i = t.indexOf(s)),
                      (r = t[i + 1]),
                      r && "expand" == r.className && r.focus(),
                      (l = !0))
                    : 40 == a &&
                      ((t = this._getVisibleButtons()),
                      (i = t.indexOf(s)),
                      (r = t[i + 1]),
                      r && "expand" == r.className && (r = t[i + 2]),
                      r || (r = t[0]),
                      r && (r.focus(), (l = !0)),
                      (l = !0)),
      ...
      function n(e) {
        ...
        return (
          ...
          (t.prototype.updateDom = function () {
            ...
            this.isVisible()
              ? e.tr.firstChild ||
                (e.tdDrag && n.appendChild(e.tdDrag),
                e.tdMenu && n.appendChild(e.tdMenu),
                n.appendChild(t))
              : e.tr.firstChild &&
                (e.tdDrag && n.removeChild(e.tdDrag),
            ...
            if (
              (i == r &&
                ("mouseover" == t
                  ...
                  : "mouseout" == t && this.editor.highlighter.unhighlight()),
              "click" == t && i == n.menu)
            ) {
              var s = this.editor.highlighter;
              s.highlight(this.parent),
                s.lock(),
                o.addClassName(n.menu, "selected"),
                this.showContextMenu(n.menu, function () {
                  o.removeClassName(n.menu, "selected"),
                    s.unlock(),
                    s.unhighlight();
                });
            }
              ...
              for (var p, m, v, A, w, C, E, F, y, b = {}; ; ) {
                if (
                  ...
                  this.defaultActions[v]
                    ? (A = this.defaultActions[v])
                    : (null == p && (p = i()), (A = a[v] && a[v][p])),
                  "undefined" == typeof A || !A.length || !A[0])
                ) {
                  if (!u) {
                    y = [];
                    for (C in a[v])
                ...
                switch (A[0]) {
                  ...
                  case 2:
                    ...
                    E &&
                      ...
                      (r = r.slice(0, -1 * E)),
                      (s = s.slice(0, -1 * E))),
                      o.push(this.productions_[A[1]][0]),
                      r.push(b.$),
                      s.push(b._$),
                      (F = a[o[o.length - 2]][o[o.length - 1]]),
                      o.push(F);
                    break;
                  case 3:
                    return !0;
          ...
          t = (function () {
            var e = {
              ...
              input: function () {
                ...
                var t = e.match(/\n/);
                return (
                  t && this.yylineno++, (this._input = this._input.slice(1)), e
                );
              },
              unput: function (e) {
      ...
      !(function () {
        function e(e) {
          var t = function (e, t) {
            ...
            r = i;
          e && (i[e] || (i[e] = {}), (r = i[e])),
            (r.define && r.define.packaged) ||
              ((n.original = r.define),
              (r.define = n),
              (r.define.packaged = !0)),
            (r.acequire && r.acequire.packaged) ||
              ((o.original = r.acequire),
              (r.acequire = t),
            ...
            o = function (e, t, i) {
              if ("[object Array]" === Object.prototype.toString.call(t)) {
                ...
                if ("string" == typeof t) {
                  var c = s(e, t);
                  return !c && o.original
                    ? o.original.apply(window, arguments)
                    : (i && i(), c);
                }
            ...
            s = function (e, t) {
              ...
              if (!i) {
                if (((i = n.payloads[t]), "function" == typeof i)) {
                  var s = {},
                    a = { id: t, uri: "", exports: s, packaged: !0 },
                    l = function (e, i) {
                      return o(t, e, i);
                    },
                    c = i(l, s, a);
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            if (
              ((h = m(g, "__defineGetter__")) &&
                ((s = u.bind(g.__defineGetter__)),
                ...
                Array.prototype.splice = function (e, t) {
                  ...
                  if (e === i) r && this.push.apply(this, o);
                    ...
                    var s = Math.min(t, i - e),
                      ...
                      h = i - s;
                    if (a > l)
                      for (var u = 0; c > u; ++u) this[l + u] = this[a + u];
                    else if (l > a)
            ...
            if (
              (Array.prototype.forEach ||
                (Array.prototype.forEach = function (e) {
                  var t = O(this),
                    i = w && "[object String]" == p(this) ? this.split("") : t,
                    n = arguments[1],
                    o = -1,
                    r = i.length >>> 0;
              ...
              Array.prototype.filter ||
                (Array.prototype.filter = function (e) {
                  var t,
                    i = O(this),
                    n = w && "[object String]" == p(this) ? this.split("") : i,
                    o = n.length >>> 0,
                    r = [],
                    s = arguments[1];
                  if ("[object Function]" != p(e))
              ...
              Array.prototype.reduceRight ||
                (Array.prototype.reduceRight = function (e) {
                  ...
                  do r in this && (o = e.call(void 0, o, i[r], r, t));
                  while (r--);
                  return o;
                }),
              (Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2)) ||
                (Array.prototype.indexOf = function (e) {
                  ...
                  var n = 0;
                  for (
                    arguments.length > 1 && (n = r(arguments[1])),
              ...
              Object.getPrototypeOf ||
                (Object.getPrototypeOf = function (e) {
                  return (
                    e.__proto__ || (e.constructor ? e.constructor.prototype : g)
                  );
                }),
            ...
            if ("undefined" != typeof document) {
              ...
              (t.getDocumentHead = function (e) {
                ...
                (t.importCssString = function (e, i, o) {
                  ...
                  var r;
                  o.createStyleSheet
                    ? ((r = o.createStyleSheet()),
                      (r.cssText = e),
                      i && (r.owningElement.id = i))
                    : ((r = o.createElementNS
                        ? o.createElementNS(n, "style")
                        : o.createElement("style")),
                      r.appendChild(o.createTextNode(e)),
                      i && (r.id = i),
                      t.getDocumentHead(o).appendChild(r));
                }),
          ...
          function (e, t, i) {
            ...
            var n = e("./oop"),
              o = (function () {
                ...
                return (
                  ...
                  (function () {
                    for (
                      var e = ["cmd", "ctrl", "alt", "shift"],
                        t = Math.pow(2, e.length);
                      t--;
            ...
            n.mixin(t, o),
              (t.keyCodeToString = function (e) {
                var t = o[e];
                return (
                  "string" != typeof t && (t = String.fromCharCode(e)),
                  t.toLowerCase()
                );
              });
          },
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            if (
              ...
              var n = (navigator.platform.match(/mac|win|linux/i) || [
                  "other",
                ])[0].toLowerCase(),
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            function n(e, t, i) {
              ...
              return n || i in o.FUNCTION_KEYS || i in o.PRINTABLE_KEYS
                ? e(t, n, i)
                : !1;
            }
            var o = e("./keys"),
            ...
            (t.addListener = function (e, t, i) {
              ...
              (t.getButton = function (e) {
                return "dblclick" == e.type
                  ? 0
                  : "contextmenu" == e.type ||
                      (r.isMac && e.ctrlKey && !e.altKey && !e.shiftKey)
                    ? 2
                    : e.preventDefault
                      ? e.button
            ...
            var n = e("../lib/event"),
              ...
              c = function (e, t) {
                ...
                (u.className = "ace_text-input"),
                  o.isTouchPad && u.setAttribute("x-palm-disable-auto-cap", !0),
                  (u.wrap = "off"),
                  (u.autocorrect = "off"),
                  (u.autocapitalize = "off"),
                  (u.spellcheck = !1),
                  (u.style.opacity = "0"),
                  o.isOldIE && (u.style.top = "-100px"),
                ...
                if (
                  ...
                  n.addListener(u, "keyup", function (e) {
                    return (
                      !p || (u.value && !S[e.keyCode]) || setTimeout(P, 0),
                      (u.value.charCodeAt(0) || 0) < 129
                        ? x.call()
                        : void (p ? I() : N())
                    );
                  }),
                ...
                var D = !1,
                        ...
                        : e == d.charAt(0)
                          ...
                          : (e.substring(0, 2) == d
                              ...
                              : e.charAt(0) == d.charAt(0)
                                ? (e = e.substr(1))
                                : e.charAt(e.length - 1) == d.charAt(0) &&
                                  (e = e.slice(0, -1)),
                            e.charAt(e.length - 1) == d.charAt(0) &&
                              (e = e.slice(0, -1)),
                            e && t.onTextInput(e)),
                  ...
                  R = function (e, o) {
                    ...
                    return r
                      ? void (_(e, r)
                          ? (o ? t.onCut() : t.onCopy(), n.preventDefault(e))
                          : ((g = !0),
                            (u.value = r),
                            u.select(),
                            setTimeout(function () {
                ...
                n.addCommandKeyListener(u, t.onCommandKey.bind(t)),
                  n.addListener(u, "select", $),
                  n.addListener(u, "input", L),
                  n.addListener(u, "cut", T),
                  n.addListener(u, "copy", M),
                  n.addListener(u, "paste", O),
                    ...
                    if (t.onCompositionEnd && !t.$readOnly) {
                      ...
                      (B = function (e) {
                        ...
                        "compositionend" == e.type &&
                          i.range &&
                          t.selection.setRange(i.range);
                    }
                  },
                  W = s.delayedCall(I, 50);
                n.addListener(u, "compositionstart", N),
                  o.isGecko
                  ...
                  n.addListener(u, "compositionend", P),
                  ...
                  (this.moveToMouse = function (e, i) {
                    if (i || !o.isOldIE) {
                      ...
                      var s = t.container.getBoundingClientRect(),
                        ...
                        g = function (e) {
                          (u.style.left = e.clientX - c - 2 + "px"),
                            (u.style.top =
                              Math.min(e.clientY - l - 2, d) + "px");
                        };
                      g(e),
                        "mousedown" == e.type &&
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            var s =
              (e("../lib/dom"), e("../lib/event"), e("../lib/useragent"), 0);
            (function () {
              (this.onMouseDown = function (e) {
                  ...
                  if (this.$clickSelection) {
                    ...
                    if (-1 == s && 0 >= a)
                      (t = this.$clickSelection.end),
                        (o.end.row != n.row || o.end.column != n.column) &&
                          (n = o.start);
                    else if (1 == a && s >= 0)
                      (t = this.$clickSelection.start),
                        (o.start.row != n.row || o.start.column != n.column) &&
                          (n = o.end);
                ...
                (this.focusWait = function () {
                  var e = o(
                    ...
                    t = Date.now();
                  (e > s || t - this.mousedownEvent.time > this.$focusTimout) &&
                ...
                (this.onDoubleClick = function (e) {
                  ...
                  o
                    ? (o.isEmpty() && (o.start.column--, o.end.column++),
                      this.setState("select"))
                    : ((o = i.selection.getWordRange(t.row, t.column)),
                ...
                (this.onTripleClick = function (e) {
                  ...
                  n.isMultiLine() && n.contains(t.row, t.column)
                    ? ((this.$clickSelection = i.selection.getLineRange(
                        n.start.row,
                      )),
          ...
          function (e, t, i) {
            ...
            function n(e) {
              function t() {
                ...
                if (t == r) {
                  var a = s.renderer.pixelToScreenCoordinates(0, u.y).row,
                    h = u.$pos;
                ...
                if (d != o)
                  if (
                    ...
                    var g =
                        l.$cells[s.session.documentToScreenRow(t, 0)].element,
                  ...
                  if ("foldWidgets" != i) {
                    ...
                    if (t.getShiftKey()) o.selectTo(n, 0);
                      ...
                      if (2 == t.domEvent.detail)
                        return s.selectAll(), t.preventDefault();
              ...
              e.editor.setDefaultHandler("guttermousemove", function (o) {
                ...
                return r.hasCssClass(s, "ace_fold-widget")
                  ? i()
                  : (d && e.$tooltipFollowsMouse && n(o),
                    (u = o),
                    void (
                      h ||
            ...
            function n(e) {
              function t(e, t) {
                ...
                if (!B || n || r)
                  ...
                  s > h
                    ? (B = null)
                    : i - B >= c &&
                      (m.renderer.scrollCursorIntoView(), (B = null));
                }
              }
              function i(e, t) {
                var i = Date.now(),
                  ...
                  s = {
                    x: { left: C - r.left, right: r.right - C },
                    y: { top: E - r.top, bottom: r.bottom - E },
                  },
                ...
                u || (d && !g)
                  ? $
                    ? i - $ >= l && m.renderer.scrollCursorIntoView(h)
                    : ($ = i)
                  : ($ = null);
              }
              function n() {
                var e = b;
                (b = m.renderer.screenToTextCoordinates(C, E)),
                  t(b, e),
                  i(b, e);
              }
              function u() {
                (y = m.selection.toOrientedRange()),
                  (w = m.session.addMarker(
                    y,
                    "ace_selection",
                    m.getSelectionStyle(),
                  )),
                  ...
                  (F = setInterval(n, 20)),
                  (L = 0),
                  s.addListener(document, "mousemove", g);
              }
              function d() {
                clearInterval(F),
                  m.session.removeMarker(w),
                  (w = null),
                  (m.$blockScrolling += 1),
                  m.selection.fromOrientedRange(y),
                  (m.$blockScrolling -= 1),
                  m.isFocused() &&
                    !S &&
                    m.renderer.$cursorLayer.setBlinking(!m.getReadOnly()),
                  (y = null),
                  (b = null),
                  (L = 0),
                  ($ = null),
                  (B = null),
                  s.removeListener(document, "mousemove", g);
              }
              function g() {
                null == _ &&
              ...
              (this.onDragStart = function (e) {
                ...
                (i.effectAllowed = m.getReadOnly() ? "copy" : "copyMove"),
                  a.isOpera && (m.container.appendChild(v), (v.scrollTop = 0)),
                ...
                (this.onDragEnter = function (e) {
                  return !m.getReadOnly() && f(e.dataTransfer)
                    ? ((C = e.clientX),
                      (E = e.clientY),
                      w || u(),
                      L++,
                ...
                (this.onDrop = function (e) {
                  if (b) {
                    ...
                    if (S)
                      ...
                      (y = { start: b, end: m.session.insert(b, i) }),
                        m.focus(),
                        (x = null);
                    }
            ...
            (n._emit = n._dispatchEvent =
              function (e, t) {
                ...
                if (i.length || n) {
                  ...
                  for (
                    var s = 0;
                    s < i.length && (i[s](t, this), !t.propagationStopped);
                    s++
                  );
              ...
              (n.setDefaultHandler = function (e, t) {
                ...
                if (
                  (i || (i = this._defaultHandlers = { _disabled_: {} }), i[e])
                ) {
                  var n = i[e],
                    o = i._disabled_[e];
          ...
          function (e, t, n) {
                ...
                if (p) {
                  for (var m = f.attributes, v = 0, A = m.length; A > v; v++) {
                    ...
                    0 === w.name.indexOf("data-ace-") &&
                      (s[r(w.name.replace(/^data-ace-/, ""))] = w.value);
                  }
                  var C = p.match(/^(.*)\/ace(\-\w+)?\.js(\?|$)/);
                  C && (a = C[1]);
                }
              }
              a && ((s.base = s.base || a), (s.packaged = !0)),
                (s.basePath = s.base),
            ...
            (t.get = function (e) {
              ...
              (t.loadModule = function (i, n) {
                ...
                if (
                  ...
                  return t.get("packaged")
                    ? void l.loadScript(t.moduleUrl(i, r), a)
                    : a();
                }
              }),
              o(!0),
            ...
            var d = {
                ...
                setOption: function (e, t) {
                  if (this["$" + e] !== t) {
                    ...
                    if (i.forwardTo)
                      return (
                        this[i.forwardTo] && this[i.forwardTo].setOption(e, t)
                      );
            ...
            (t.defineOptions = function (e, t, i) {
              ...
              (t.setDefaultValue = function (e, i, n) {
                ...
                o[i] &&
                  (o.forwardTo
                    ? t.setDefaultValue(o.forwardTo, i, n)
                    : (o[i].value = n));
              }),
          ...
          function (e, t, i) {
                  ...
                  e.on("mousemove", function (i) {
                    if (!t.state && !t.$dragDelay && t.$dragEnabled) {
                      var n = e.renderer.screenToTextCoordinates(i.x, i.y),
                        ...
                        r = e.renderer;
                      r.setCursorStyle(
                        !o.isEmpty() && o.insideStart(n.row, n.column)
                          ? "default"
                          : "",
                      );
                    }
            ...
            (function () {
              ...
              c.defineOptions(h.prototype, "mouseHandler", {
                ...
                dragDelay: { initialValue: o.isMac ? 150 : 0 },
          ...
          function (e, t, i) {
            ...
            function n(e) {
              e.on("click", function (t) {
                ...
                o &&
                  (t.getAccelKey() ? n.removeFold(o) : n.expandFold(o),
                  t.stop());
              }),
                e.on("gutterclick", function (t) {
                  ...
                  if ("foldWidgets" == i) {
                    ...
                    o.foldWidgets &&
                      o.foldWidgets[n] &&
                      e.session.onFoldWidgetClick(n, t),
                      e.isFocused() || e.focus(),
                      t.stop();
                  }
                }),
              ...
              (this.setDefaultHandler = function (e) {
                ...
                (this.$callKeyboardHandlers = function (e, t, i, n) {
                  for (
                    ...
                    l-- &&
                    ((r = this.$handlers[l].handleKeyboard(
                      this.$data,
                      e,
                      t,
                      i,
                    ...
                    !(
                      ...
                      ((s =
                        "null" == r.command
                          ? !0
                          : a.exec(r.command, this.$editor, r.args, n)),
                      s &&
                        n &&
                        -1 != e &&
                        1 != r.passEvent &&
            ...
            (function () {
              (this.isEqual = function (e) {
                ...
                (this.containsRange = function (e) {
                  return (
                    0 == this.comparePoint(e.start) &&
                    0 == this.comparePoint(e.end)
                  );
                }),
                ...
                (this.collapseRows = function () {
                  return 0 == this.end.column
                    ...
                    : new o(this.start.row, 0, this.end.row, 0);
                }),
            ...
            (function () {
              n.implement(this, r),
                ...
                (this.getLineRange = function (e, t) {
                  ...
                  return (
                    o ? ((n = o.start.row), (i = o.end.row)) : (i = n),
                    t === !0
                      ? new s(n, 0, i, this.session.getLine(i).length)
                      : new s(n, 0, i + 1, 0)
                  );
                }),
                ...
                (this.moveCursorLeft = function () {
                  ...
                  if ((e = this.session.getFoldAt(t.row, t.column, -1)))
                    ...
                    t.row > 0 &&
                      this.moveCursorTo(
                        t.row - 1,
                        this.doc.getLine(t.row - 1).length,
                      );
                  else {
                ...
                (this.moveCursorLongWordRight = function () {
                  ...
                  return r
                    ...
                    : ((e = this.session.nonTokenRe.exec(o)) &&
                ...
                (this.moveCursorLongWordLeft = function () {
                  ...
                  return (
                    (this.session.nonTokenRe.lastIndex = 0),
                    (this.session.tokenRe.lastIndex = 0),
                    (r = this.session.nonTokenRe.exec(s)) &&
                      ((i -= this.session.nonTokenRe.lastIndex),
                ...
                (this.moveCursorBy = function (e, t) {
                  ...
                  var n = this.session.screenToDocumentPosition(
                    i.row + e,
                    i.column,
                  );
                  0 !== e &&
              ...
              o = function (e) {
                ...
                for (var t in this.states) {
                  for (
                    ...
                    var c = i[l];
                    if (
                      (c.defaultToken && (r.defaultToken = c.defaultToken),
            ...
            (function () {
              (this.$setMaxTokenCount = function (e) {
                ...
                (this.$arrayTokens = function (e) {
                  ...
                  if (!t) return "text";
                  for (
                    var i = [], n = this.tokenArray, o = 0, r = n.length;
                    r > o;
                    o++
                  )
                ...
                (this.getLineTokens = function (e, t) {
                  ...
                  for (
                    ...
                    if (m - p.length > h) {
                      ...
                      d.type == g
                        ? (d.value += v)
                        : (d.type && c.push(d), (d = { type: g, value: v }));
                    }
                    for (var A = 0; A < l.length - 2; A++)
                      if (void 0 !== l[A + 1]) {
                        (f = r[s[A]]),
                          (g = f.onMatch ? f.onMatch(p, o, i) : f.token),
                          f.next &&
                            ((o =
                            ...
                            (r = this.states[o]),
                            r ||
                              (this.reportError("state doesn't exist", o),
                              (o = "start"),
                              (r = this.states[o])),
                    ...
                    if (p)
                      if ("string" == typeof g)
                        (f && f.merge === !1) || d.type !== g
                          ? (d.type && c.push(d), (d = { type: g, value: p }))
                          : (d.value += p);
                      else if (g) {
                  ...
                  return (
                    d.type && c.push(d),
                    i.length > 1 && i[0] !== o && i.unshift("#tmp", o),
                    { tokens: c, state: i.length ? i : o }
                  );
                }),
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            (function () {
              (this.addRules = function (e, t) {
                    ...
                    for (var n = e[i], o = 0; o < n.length; o++) {
                      ...
                      (r.next || r.onMatch) &&
                        ("string" != typeof r.next
                          ...
                          : 0 !== r.next.indexOf(t) && (r.next = t + r.next));
                    }
                    this.$rules[t + i] = n;
                  }
                ...
                (this.embedRules = function (e, t, i, o, r) {
                  ...
                  if ((this.addRules(s, t), i))
                    for (
                      var c = Array.prototype[r ? "push" : "unshift"], a = 0;
                      a < o.length;
                      a++
                    )
              ...
              var e = function (e, t) {
                  return (
                    ("start" != e || t.length) && t.unshift(this.nextState, e),
                    this.nextState
                  );
                },
                t = function (e, t) {
                  ...
                  for (var a = 0; a < s.length; a++) {
                    ...
                    if (
                      ...
                      for (var u in l.rules)
                        o[u]
                          ? o[u].push && o[u].push.apply(o[u], l.rules[u])
                          : (o[u] = l.rules[u]);
                  ...
                  if (this.lineCommentStart) {
                    ...
                    var f = function (e, t) {
                      ...
                      m = function (e, t) {
                        (!s || /\S/.test(e)) &&
                          (A(e, c, c)
                            ? r.insertInLine({ row: t, column: c }, p)
                            : r.insertInLine({ row: t, column: c }, g));
                      },
                      v = function (e, t) {
                        return d.test(e);
                      },
                    ...
                    var g = this.blockComment.start,
                      ...
                      m = function (e, t) {
                        v(e, t) ||
                          ((!s || /\S/.test(e)) &&
                            (r.insertInLine({ row: t, column: e.length }, w),
                            r.insertInLine({ row: t, column: c }, g)));
                      },
                      f = function (e, t) {
                        var i;
                        (i = e.match(C)) &&
                          r.removeInLine(t, e.length - i[0].length, e.length),
                          (i = e.match(d)) &&
                            r.removeInLine(t, i[1].length, i[0].length);
                      },
                      v = function (e, i) {
                ...
                (this.toggleBlockComment = function (e, t, i, n) {
                  ...
                  if (o) {
                    ...
                    if (h && /comment/.test(h.type)) {
                      ...
                      for (
                        var a = new l(t, n.row, n.column),
                          h = a.getCurrentToken();
                        h && /comment/.test(h.type);
                    ...
                    u.start.row == r && (u.start.column += s),
                      u.end.row == r && (u.end.column += s),
                    ...
                    for (var n in t)
                      for (var o = t[n], r = 0, s = o.length; s > r; r++)
                        if ("string" == typeof o[r].token)
                          /keyword|support|storage/.test(o[r].token) &&
                            i.push(o[r].regex);
              ...
              n.implement(this, o),
                ...
                (this.onChange = function (e) {
                  var t = e.data,
                    i = t.range;
                  if (
                    (i.start.row != i.end.row || i.start.row == this.row) &&
                    !(
                      i.start.row > this.row ||
                      (i.start.row == this.row && i.start.column > this.column)
                    )
                  ) {
                    var n = this.row,
                      o = this.column,
                    ...
                    "insertText" === t.action
                      ? r.row === n && r.column <= o
                        ? (r.column === o && this.$insertRight) ||
                          (r.row === s.row
                            ? (o += s.column - r.column)
                            : ((o -= r.column), (n += s.row - r.row)))
                        : r.row !== s.row && r.row < n && (n += s.row - r.row)
                      : "insertLines" === t.action
                        ? (r.row === n && 0 === o && this.$insertRight) ||
                          (r.row <= n && (n += s.row - r.row))
                        : "removeText" === t.action
                          ? r.row === n && r.column < o
                            ? (o =
                                s.column >= o
                                  ? r.column
                                  : Math.max(0, o - (s.column - r.column)))
                            : r.row !== s.row && r.row < n
                              ? (s.row === n &&
                                  (o = Math.max(0, o - s.column) + r.column),
                                (n -= s.row - r.row))
                              : s.row === n &&
                                ((n -= s.row - r.row),
                                (o = Math.max(0, o - s.column) + r.column))
                          : "removeLines" == t.action &&
                            r.row <= n &&
                            (s.row <= n
                              ? (n -= s.row - r.row)
                              : ((n = r.row), (o = 0))),
                      this.setPosition(n, o, !0);
                  }
                }),
                (this.setPosition = function (e, t, i) {
                  ...
                  if (
                    ...
                    (this.row = n.row),
                      ...
                      this._signal("change", { old: o, value: n });
                  }
                }),
                (this.detach = function () {
                  ...
                  return (
                    e >= this.document.getLength()
                      ...
                      : 0 > e
                        ...
                        : ((i.row = e),
                          (i.column = Math.min(
                            this.document.getLine(i.row).length,
                            Math.max(0, t),
                          ))),
                    0 > t && (i.column = 0),
                    i
            ...
            (function () {
              n.implement(this, o),
                (this.setValue = function (e) {
                  ...
                  this.remove(new r(0, 0, t, this.getLine(t - 1).length)),
                    this.insert({ row: 0, column: 0 }, e);
                }),
                ...
                (this.getTextRange = function (e) {
                  ...
                  var i = t.length - 1;
                  return (
                    e.end.row - e.start.row == i &&
                      (t[i] = t[i].substring(0, e.end.column)),
                ...
                (this._insertLines = function (e, t) {
                  ...
                  var o = new r(e, 0, e + t.length, 0),
                    s = { action: "insertLines", range: o, lines: t };
                ...
                (this.insertInLine = function (e, t) {
                  ...
                  this.$lines[e.row] =
                    i.substring(0, e.column) + t + i.substring(e.column);
                ...
                (this.removeLines = function (e, t) {
                  return 0 > e || t >= this.getLength()
                    ? this.remove(new r(e, 0, t + 1, 0))
                    : this._removeLines(e, t);
                }),
                (this._removeLines = function (e, t) {
                  var i = new r(e, 0, t + 1, 0),
                ...
                (this.applyDeltas = function (e) {
                  for (var t = 0; t < e.length; t++) {
                    var i = e[t],
                      n = r.fromPoints(i.range.start, i.range.end);
                    "insertLines" == i.action
                      ? this.insertLines(n.start.row, i.lines)
                      : "insertText" == i.action
                        ? this.insert(n.start, i.text)
                        : "removeLines" == i.action
                          ? this._removeLines(n.start.row, n.end.row - 1)
                          : "removeText" == i.action && this.remove(n);
                  }
                }),
                  ...
                  for (var t = e.length - 1; t >= 0; t--) {
                    ...
                    "insertLines" == i.action
                      ...
                      : "insertText" == i.action
                        ? this.remove(n)
                        : "removeLines" == i.action
                          ? this._insertLines(n.start.row, i.lines)
                          : "removeText" == i.action &&
                            this.insert(n.start, i.text);
                  }
                }),
            ...
            var n = e("./lib/oop"),
              ...
              r = function (e, t) {
                ...
                this.$worker = function () {
                  if (i.running) {
                    for (
                      var e = new Date(), t = i.currentLine, n = -1, o = i.doc;
                      i.lines[t];
              ...
              n.implement(this, o),
                ...
                (this.$updateOnChange = function (e) {
                  ...
                  if (0 === n) this.lines[i] = null;
                    ...
                    "removeText" == e.action ||
                    "removeLines" == e.action
                  )
                    this.lines.splice(i, n + 1, null),
                      this.states.splice(i, n + 1, null);
                  else {
                    var o = Array(n + 1);
                    o.unshift(i, 1),
                      this.lines.splice.apply(this.lines, o),
                      this.states.splice.apply(this.states, o);
                  }
                  (this.currentLine = Math.min(
                    i,
                    this.currentLine,
            ...
            (function () {
              (this.MAX_RANGES = 500),
                ...
                (this.update = function (e, t, i, r) {
                  if (this.regExp)
                    for (
                      var s = r.firstRow, a = r.lastRow, l = s;
                      a >= l;
                      l++
                    ) {
                      var c = this.cache[l];
                      null == c &&
                        ((c = n.getMatchOffsets(i.getLine(l), this.regExp)),
                        c.length > this.MAX_RANGES &&
              ...
              (this.shiftRow = function (e) {
                  ...
                  if (e.sameRow) {
                    ...
                    this.folds.push(e),
                      ...
                      this.range.compareEnd(e.start.row, e.start.column) > 0
                        ? ((this.end.row = e.end.row),
                          (this.end.column = e.end.column))
                        : this.range.compareStart(e.end.row, e.end.column) <
                            0 &&
                          ((this.start.row = e.start.row),
                          (this.start.column = e.start.column));
                ...
                (this.walk = function (e, t, i) {
                  ...
                  for (var c = 0; c < a.length; c++) {
                    ...
                    if (
                      ((r = e(null, n.start.row, n.start.column, s, l)),
                      (r =
                        !r && e(n.placeholder, n.start.row, n.start.column, s)),
                      r || 0 === o)
                    )
                      return;
            ...
            (function () {
              (this.comparePoints = o),
                ...
                (this.add = function (e) {
                  ...
                  return (
                    0 > n ? (n = -n - 1) : n++, this.ranges.splice(i, n - i, e)
                  );
                }),
                ...
                (this.$onChange = function (e) {
                  ...
                  for (
                    ...
                    if (!(u.end.row < o)) {
                      ...
                      if (
                        (u.start.row == o &&
                          u.start.column >= i.column &&
                          ((u.start.column == i.column && this.$insertRight) ||
                            ((u.start.column += a), (u.start.row += s))),
                        u.end.row == o && u.end.column >= i.column)
                      ) {
                        if (u.end.column == i.column && this.$insertRight)
                          continue;
                        u.end.column == i.column &&
                          a > 0 &&
                          h - 1 > c &&
                          u.end.column > u.start.column &&
                          u.end.column == l[c + 1].start.column &&
                          (u.end.column -= a),
                          (u.end.column += a),
                          (u.end.row += s);
                      }
              ...
              (this.getFoldAt = function (e, t, i) {
                ...
                (this.getFoldStringAt = function (e, t, i, n) {
                  ...
                  for (
                    ...
                    if (-1 == l) {
                      o = this.getLine(r.start.row).substring(
                        s.end.column,
                        r.start.column,
                      );
                      break;
                  ...
                  return (
                    o ||
                      (o = this.getLine(r.start.row).substring(s.end.column)),
                    -1 == i
                      ? o.substring(0, t - s.end.column)
                      : 1 == i
                        ? o.substring(t - s.end.column)
                        : o
                  );
                }),
                ...
                (this.getFoldedRowCount = function (e, t) {
                  for (
                    var i = this.$foldData, n = t - e + 1, o = 0;
                    o < i.length;
                    o++
                  ) {
                    var r = i[o],
                ...
                (this.addFold = function (e, t) {
                  ...
                  u && !u.range.isStart(a, l) && this.removeFold(u),
                    d && !d.range.isEnd(c, h) && this.removeFold(d);
                ...
                (this.unfold = function (e, t) {
                  ...
                  if (
                    (null == e
                      ? ((i = new o(0, 0, this.getLength(), 0)), (t = !0))
                      : (i =
                          "number" == typeof e
                            ? new o(e, 0, e, this.getLine(e).length)
                            : "row" in e
                              ? o.fromPoints(e, e)
                              : e),
                ...
                (this.toggleFold = function (e) {
                  ...
                  if (o.isEmpty()) {
                    ...
                    (i = this.findMatchingBracket(r))
                      ? 1 == o.comparePoint(i)
                        ? (o.end = i)
                        : ((o.start = i), o.start.column++, o.end.column--)
                      : (i = this.findMatchingBracket({
                        ...
                        ? (1 == o.comparePoint(i) ? (o.end = i) : (o.start = i),
                          o.start.column++)
                        : (o = this.getCommentFoldRange(r.row, r.column) || o);
                  } else {
                  ...
                  if (
                    (t || (t = this.getFoldAt(o.start.row, o.start.column)),
                ...
                (this.getCommentFoldRange = function (e, t, i) {
                  ...
                  if (r && /^comment|string/.test(r.type)) {
                    ...
                    if (
                      ((s.start.row = n.getCurrentTokenRow()),
                    ...
                    return (
                      (s.end.row = n.getCurrentTokenRow()),
                      (s.end.column =
                        n.getCurrentTokenColumn() + r.value.length - 2),
                      s
                    );
                  }
                }),
                (this.foldAll = function (e, t, i) {
                  ...
                  if (n) {
                    ...
                    for (var o = e; t > o; o++)
                      if (
                        (null == n[o] && (n[o] = this.getFoldWidget(o)),
                        "start" == n[o])
                      ) {
                ...
                (this.getParentFoldRangeData = function (e, t) {
                  ...
                  for (var n, o = e - 1; o >= 0; ) {
                    var r = i[o];
                    if (
                      (null == r && (r = i[o] = this.getFoldWidget(o)),
                      "start" == r)
                    ) {
                ...
                (this.onFoldWidgetClick = function (e, t) {
                  ...
                  if (!n) {
                    ...
                    o &&
                      /ace_fold-widget/.test(o.className) &&
                      (o.className += " ace_invalid");
                  }
                }),
                (this.$toggleFoldWidget = function (e, t) {
                  if (this.getFoldWidget) {
                    ...
                    if (t.siblings) {
                      ...
                      t.children
                        ? ((c = s ? s.end.row : this.getLength()),
                          this.foldAll(e + 1, s.end.row, t.all ? 1e4 : 0))
                        : s &&
                          (t.all && (s.collapseChildren = 1e4),
                          this.addFold("...", s));
                    return s;
                  }
                }),
            ...
            (function () {
              ...
              n.implement(this, s),
                ...
                (this.$resetRowCache = function (e) {
                  if (!e)
                    return (
                      (this.$docRowCache = []), void (this.$screenRowCache = [])
                    );
                ...
                (this.getTokenAt = function (e, t) {
                  ...
                  if (null == t)
                    ...
                    for (
                      var r = 0;
                      r < n.length && ((o += n[r].value.length), !(o >= t));
                      r++
                    );
                  return (i = n[r])
                    ? ((i.index = r), (i.start = o - i.value.length), i)
                    : null;
                }),
                (this.setUndoManager = function (e) {
                  if (
                    ...
                    (this.$syncInformUndoManager = function () {
                      ...
                      (this.$informUndoManager = o.delayedCall(
                ...
                (this.getTabString = function () {
                  return this.getUseSoftTabs()
                    ? o.stringRepeat(" ", this.getTabSize())
                    : "	";
                }),
                ...
                (this.addMarker = function (e, t, i, n) {
                  ...
                  return (
                    n
                      ? ((this.$frontMarkers[o] = r),
                        this._signal("changeFrontMarker"))
                      : ((this.$backMarkers[o] = r),
                ...
                (this.$computeWidth = function (e) {
                  if (this.$modified || e) {
                    ...
                    for (
                      ...
                      null == i[l] &&
                        (i[l] = this.$getStringScreenWidth(t[l])[0]),
                        i[l] > n && (n = i[l]);
                    }
                    this.screenWidth = n;
                  }
                ...
                (this.undoChanges = function (e, t) {
                  if (e.length) {
                    ...
                    for (var i = null, n = e.length - 1; -1 != n; n--) {
                      var o = e[n];
                      "doc" == o.group
                        ? (this.doc.revertDeltas(o.deltas),
                          (i = this.$getUndoSelection(o.deltas, !0, i)))
                        : o.deltas.forEach(function (e) {
                ...
                (this.$getUndoSelection = function (e, t, i) {
                  function n(e) {
                    var i =
                      "insertText" === e.action || "insertLines" === e.action;
                    return t ? !i : i;
                  }
                  var o,
                    r,
                    ...
                    a = !1;
                  n(s)
                    ? ((o = c.fromPoints(s.range.start, s.range.end)), (a = !0))
                    : ((o = c.fromPoints(s.range.start, s.range.start)),
                      (a = !1));
                  for (var l = 1; l < e.length; l++)
                    (s = e[l]),
                      n(s)
                        ? ((r = s.range.start),
                          -1 == o.compare(r.row, r.column) &&
                            o.setStart(s.range.start),
                          (r = s.range.end),
                          1 == o.compare(r.row, r.column) &&
                            o.setEnd(s.range.end),
                          (a = !0))
                        : ((r = s.range.start),
                          -1 == o.compare(r.row, r.column) &&
                            (o = c.fromPoints(s.range.start, s.range.start)),
                          (a = !1));
                  if (null != i) {
                    0 === c.comparePoints(i.start, o.start) &&
                      ((i.start.column += o.end.column - o.start.column),
                  ...
                  if (!i) {
                    ...
                    a &&
                      (r.start.row == e.end.row &&
                        ...
                        (r.start.column += a),
                      r.end.row == e.end.row &&
                        r.end.column > e.end.column &&
                        (r.end.column += a)),
                      s &&
                        r.start.row >= e.end.row &&
                        ((r.start.row += s), (r.end.row += s));
                  }
                ...
                (this.outdentRows = function (e) {
                  for (
                    ...
                    n > s && "	" == r.charAt(s)
                      ? ((i.start.column = s), (i.end.column = s + 1))
                      : ((i.start.column = 0), (i.end.column = s)),
                      this.remove(i);
                  }
                }),
                (this.$moveLines = function (e, t, i) {
                  ...
                  var r = new c(e, 0, t, Number.MAX_VALUE),
                    s = this.getFoldsInRange(r).map(function (e) {
                      return (
                        (e = e.clone()), (e.start.row += o), (e.end.row += o), e
                      );
                    }),
                    a =
                      0 == i
                        ? this.doc.getLines(e, t)
                        : this.doc.removeLines(e, t);
                  return (
                ...
                (this.$constrainWrapLimit = function (e, t, i) {
                  return (
                    t && (e = Math.max(t, e)), i && (e = Math.min(i, e)), e
                  );
                }),
                ...
                (this.$updateInternalDataOnChange = function (e) {
                  ...
                  if (
                    (-1 != n.indexOf("Lines")
                      ? ((r = "insertLines" == n ? o + e.data.lines.length : o),
                        (t = e.data.lines ? e.data.lines.length : r - o))
                      : (t = r - o),
                    (this.$updating = !0),
                    0 != t)
                  )
                    if (-1 != n.indexOf("remove")) {
                      ...
                      var h = this.getFoldLine(a.row),
                        u = 0;
                      if (h) {
                        h.addRemoveChars(a.row, a.column, s.column - a.column),
                          h.shiftRow(-t);
                      ...
                      if (h) {
                        ...
                        0 == p
                          ? ((h = h.split(s.row, s.column)),
                            h &&
                              (h.shiftRow(t),
                              h.addRemoveChars(r, 0, a.column - s.column)))
                          : -1 == p &&
                            (h.addRemoveChars(o, 0, a.column - s.column),
                            h.shiftRow(t)),
                          (u = c.indexOf(h) + 1);
                      }
                      for (u; u < c.length; u++) {
                  ...
                  return (
                    ...
                    (this.$updating = !1),
                    i
                      ? this.$updateWrapData(o, r)
                      : this.$updateRowLengthCache(o, r),
                    l
                  );
                }),
                      ...
                      n
                        ? ((i = []),
                          n.walk(
                            ...
                            n.end.row,
                            o[n.end.row].length + 1,
                          ),
                          (s[n.start.row] = this.$computeWrapSplits(i, l, r)),
                          (c = n.end.row + 1))
                        : ((i = this.$getDisplayTokens(o[c])),
              ...
              (this.$computeWrapSplits = function (e, t) {
                ...
                for (
                  var o = [], r = e.length, s = 0, l = 0, c = this.$wrapAsCode;
                  r - s > t;

                ) {
                  var u = s + t;
                  if (e[u - 1] >= f && e[u] >= f) n(u);
                  else if (e[u] != a && e[u] != h) {
                    for (
                      var d = Math.max(u - (c ? 10 : t - (t >> 2)), s - 1);
                      u > d && e[u] < a;
                ...
                (this.screenToDocumentPosition = function (e, t) {
                  ...
                  for (
                    var d = this.getLength() - 1,
                      g = this.getNextFoldLine(o),
                      f = g ? g.start.row : 1 / 0;
                    e >= s &&
                    ((a = this.getRowLength(o)), !(s + a > e || o >= d));
                    ...
                    (s += a),
                      ...
                      o > f &&
                        ...
                        (f = g ? g.start.row : 1 / 0)),
                      u &&
                        (this.$docRowCache.push(o),
                        this.$screenRowCache.push(s));
                  if (g && g.start.row <= o)
                    (i = this.getFoldDisplayLine(g)), (o = g.start.row);
                  else {
                    if (e >= s + a || o > d)
                  ...
                  if (this.$useWrapMode) {
                    ...
                    if (p) {
                      ...
                      (n = p[m]),
                        m > 0 &&
                          p.length &&
                          ((r = p[m - 1] || p[p.length - 1]),
                          (i = i.substring(r)));
                    }
                  }
                  return (
                    (r += this.$getStringScreenWidth(i, t)[1]),
                    this.$useWrapMode && r >= n && (r = n - 1),
                    g ? g.idxToPosition(r) : { row: o, column: r }
                  );
                }),
                (this.documentToScreenPosition = function (e, t) {
                  ...
                  if (
                    (d && a >= g
                      ? ((f = this.getFoldDisplayLine(d, e, t)),
                        (o = d.start.row))
              ...
              (this.set = function (e) {
                ...
                (this.findAll = function (e) {
                  ...
                  if (t.$isMultiLine) {
                    ...
                    e: for (var u = a.offset || 0; h >= u; u++) {
                      ...
                      (l && l.end.row === u && l.end.column > p) ||
                        (s.push((l = new r(u, p, u + c - 1, m))),
                        c > 2 && (u = u + c - 2));
                    }
                  } else
                    for (var v = 0; v < o.length; v++)
                      for (
                        var A = n.getMatchOffsets(o[v], a), d = 0;
                        d < A.length;
                        d++
                      ) {
                        var w = A[d];
                  ...
                  if (i) {
                    ...
                    for (
                      ;
                      d > v && s[d].end.column > E && s[d].end.row == i.end.row;
                ...
                (this.$matchIterator = function (e, t) {
                  ...
                  if (t.$isMultiLine)
                    ...
                    var c = function (e, t, r) {
                      for (
                        var s = n.getMatchOffsets(e, i), a = s.length - 1;
                        a >= 0;
                        a--
                      )
                    ...
                    var c = function (e, t, r) {
                      for (
                        var s = n.getMatchOffsets(e, i), a = 0;
                        a < s.length;
                        a++
                      )
                        if (o(s[a], t, r)) return !0;
                ...
                (this.$assembleMultilineRegExp = function (e, t) {
                  ...
                  return (
                    "" == i[0] ? (n.shift(), (n.offset = 1)) : (n.offset = 0), n
                  );
                }),
                (this.$lineIterator = function (e, t) {
                  var i = 1 == t.backwards,
                    ...
                    r = t.start;
                  r ||
                    (r = o ? o[i ? "end" : "start"] : e.selection.getRange()),
              ...
              function () {
                (this.addCommand = function (e) {
                  ...
                  (this.removeCommand = function (e, t) {
                    ...
                    for (var o in n) {
                      ...
                      if (r == e) delete n[o];
                        ...
                        var s = r.indexOf(e);
                        -1 != s &&
                          (r.splice(s, 1), 1 == r.length && (n[o] = r[0]));
                      }
                    }
                  }),
                  (this.bindKey = function (e, t, i) {
                    return (
                      "object" == typeof e && (e = e[this.platform]),
                      e
                        ? "function" == typeof t
                          ? this.addCommand({
                              exec: t,
                  ...
                  (this._addCommandToBinding = function (e, t, i) {
                    ...
                    t
                      ? !o[e] || this.$singleCommand
                        ? (o[e] = t)
                        : (Array.isArray(o[e])
                            ? -1 != (n = o[e].indexOf(t)) && o[e].splice(n, 1)
                            : (o[e] = [o[e]]),
                          i || t.isDefault ? o[e].unshift(t) : o[e].push(t))
                      : delete o[e];
                  }),
              ...
              function () {
                n.implement(this, r),
                  (this.exec = function (e, t, i) {
                    ...
                    return (
                      (o.returnValue = this._emit("exec", o)),
                  ...
                  (this.trimMacro = function (e) {
                    return e.map(function (e) {
                      return (
                        "string" != typeof e[0] && (e[0] = e[0].name),
                        e[1] || (e = e[0]),
                        e
                      );
                    });
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            t.commands = [
              ...
              {
                name: "foldall",
                bindKey: n("Ctrl-Alt-0", "Ctrl-Command-Option-0"),
                exec: function (e) {
                  e.session.foldAll();
                },
                scrollIntoView: "center",
                ...
                exec: function (e) {
                  for (
                    var t = e.selection.isBackwards(),
                      ...
                      l = a.replace(/\n\s*/, " ").length,
                      c = e.session.doc.getLine(i.row),
                      h = i.row + 1;
                    h <= n.row + 1;
                    h++
                  ) {
                    var u = o.stringTrimLeft(
                      o.stringTrimRight(e.session.doc.getLine(h)),
                    );
                    0 !== u.length && (u = " " + u), (c += u);
                  }
                  n.row + 1 < e.session.doc.getLength() - 1 &&
                    (c += e.session.doc.getNewLineCharacter()),
                    e.clearSelection(),
                    ...
                    l > 0
                      ...
                      : ((r =
                          e.session.doc.getLine(i.row).length > r ? r + 1 : r),
                ...
                exec: function (e) {
                  ...
                  for (var r = 0; r < n.length; r++)
                    r == n.length - 1 &&
                      ...
                      o.push(new s(n[r].end.row, n[r].end.column, t, i)),
                      0 === r
                        ? (0 !== n[r].start.row || 0 !== n[r].start.column) &&
                          o.push(new s(0, 0, n[r].start.row, n[r].start.column))
                        : o.push(
                            new s(
                              n[r - 1].end.row,
                              n[r - 1].end.column,
              ...
              n.implement(this, f),
                (this.$initOperationListeners = function () {
                  (this.selections = []),
                    ...
                    (this.$opResetTimer = r.delayedCall(
                      this.endOperation.bind(this),
                    )),
                    this.on(
                      "change",
                    ...
                    if (t && t.scrollIntoView) {
                      switch (t.scrollIntoView) {
                        ...
                        case "selectionPart":
                          ...
                          (i.start.row >= n.lastRow ||
                            i.end.row <= n.firstRow) &&
                            this.renderer.scrollSelectionIntoView(
                              this.selection.anchor,
                              this.selection.lead,
                            );
                      }
                      "animate" == t.scrollIntoView &&
                ...
                (this.setKeyboardHandler = function (e, t) {
                  if (e && "string" == typeof e) {
                    ...
                    v.loadModule(["keybinding", e], function (n) {
                      i.$keybindingId == e &&
                        i.keyBinding.setKeyboardHandler(n && n.handler),
                        t && t();
                    });
                  } else
                ...
                (this.getFontSize = function () {
                  return (
                    ...
                    o.computedStyle(this.container, "fontSize")
                  );
                }),
                    ...
                    (this.$highlightPending = !0),
                      setTimeout(function () {
                        ...
                        if (t && t.bgTokenizer) {
                          ...
                          if (i)
                            var n = new g(i.row, i.column, i.row, i.column + 1);
                      ...
                      setTimeout(function () {
                        ...
                        if (t && t.bgTokenizer) {
                          ...
                          t.$tagHighlight &&
                            0 !==
                              h.compareRange(
                                t.$backMarkers[t.$tagHighlight].range,
                              ) &&
                            (t.removeMarker(t.$tagHighlight),
                            (t.$tagHighlight = null)),
                            h &&
                ...
                (this.$getSelectionHighLightRegexp = function () {
                  ...
                  if (!t.isEmpty() && !t.isMultiLine()) {
                    ...
                    if (
                      ...
                      ((s = o.substring(t.start.column, t.end.column)),
                      /^[\w\d]+$/.test(s))
                    ) {
                ...
                (this.remove = function (e) {
                  ...
                  if (this.getBehavioursEnabled()) {
                    var i = this.session,
                      ...
                      o = i
                        .getMode()
                        .transformAction(n, "deletion", this, i, t);
                    if (0 === t.end.column) {
                ...
                (this.transposeLetters = function () {
                  if (this.selection.isEmpty()) {
                    ...
                    if (0 !== t) {
                      var i,
                        n,
                        o = this.session.getLine(e.row);
                      t < o.length
                        ? ((i = o.charAt(t) + o.charAt(t - 1)),
                          (n = new g(e.row, t - 1, e.row, t + 1)))
                        : ((i = o.charAt(t - 1) + o.charAt(t - 2)),
                ...
                (this.toggleBlockComment = function () {
                  ...
                  this.session
                    .getMode()
                    .toggleBlockComment(t, this.session, i, e);
                }),
                  ...
                  if (!isNaN(parseFloat(o)) && isFinite(o)) {
                    ...
                    if (r) {
                      ...
                      this.session.replace(h, c),
                        this.moveCursorTo(
                          t,
                          Math.max(r.start + 1, i + c.length - r.value.length),
                        );
                    }
                  }
                }),
                (this.removeLines = function () {
                  var e,
                    t = this.$getSelectedRows();
                  (e =
                    0 === t.first || t.last + 1 < this.session.getLength()
                      ? new g(t.first, 0, t.last + 1, 0)
                      : new g(
                          t.first - 1,
                          this.session.getLine(t.first - 1).length,
                          t.last,
                          this.session.getLine(t.last).length,
                        )),
                    this.session.remove(e),
                    this.clearSelection();
                }),
                    ...
                    for (var s = r.length; s--; ) {
                      for (
                        var a = s,
                          ...
                          l = n.end.row,
                          c = n.start.row;
                        s-- && ((n = r[s].collapseRows()), c - n.end.row <= 1);
                ...
                (this.$moveByPage = function (e, t) {
                  ...
                  this.$blockScrolling++,
                    t === !0
                      ...
                      : t === !1 &&
                        (this.selection.moveCursorBy(o, 0),
                    ...
                    do {
                      if (r.value.match(/[{}()\[\]]/g)) {
                        ...
                        r &&
                          ...
                          (isNaN(c[r.value]) && (c[r.value] = 0),
                          "<" === o.value
                            ? c[r.value]++
                            : "</" === o.value && c[r.value]--,
                          -1 === c[r.value] && ((s = "tag"), (l = !0)));
                        ...
                        if (
                          ...
                          do
                            (r = o),
                              (o = n.stepBackward()),
                              o &&
                                (-1 !== o.type.indexOf("tag-close") &&
                                  d.setEnd(
                                    n.getCurrentTokenRow(),
                                    n.getCurrentTokenColumn() + 1,
                                  ),
                                r.value === p &&
                                  -1 !== r.type.indexOf("tag-name") &&
                                  ("<" === o.value
                ...
                (this.find = function (e, t, i) {
                  ...
                  null == t.needle &&
                    ((e =
                      this.session.getTextRange(o) ||
                      this.$search.$options.needle),
                    e ||
                      ((o = this.session.getWordRange(
                        o.start.row,
                        o.start.column,
                      )),
                    ...
                    var r = this.on("changeSelection", function () {
                      ...
                      a = this.renderer.on("afterRender", function () {
                        if (
                          ...
                          t &&
                          (i.isFocused() ||
                            (i.searchBox && i.searchBox.isFocused()))
                        ) {
                          var e = i.renderer,
                ...
                (this.setAnnotations = function (e) {
                  ...
                  for (var t = 0; t < e.length; t++) {
                    ...
                    "error" == a
                      ...
                      : "warning" == a && " ace_error" != o.className
                        ? (o.className = " ace_warning")
                        : "info" != a ||
                          o.className ||
                          (o.className = " ace_info");
                  }
                }),
                ...
                (this.update = function (e) {
                  for (
                    ...
                    l[p] && (m += l[p]),
                      c[p] && (m += c[p]),
                      this.$annotations[p] &&
                        (m += this.$annotations[p].className),
                      g.element.className != m && (g.element.className = m);
                    var v = t.getRowLength(p) * e.lineHeight + "px";
                    if (
                      (v != g.element.style.height &&
                        (g.element.style.height = v),
                      a)
                    ) {
                      var A = a[p];
                    ...
                    if (A) {
                      ...
                      (m +=
                        "start" == A && p == s && p < r.end.row
                          ? " ace_closed"
                          : " ace_open"),
                        g.foldWidget.className != m &&
                          (g.foldWidget.className = m);
                      var v = e.lineHeight + "px";
                      g.foldWidget.style.height != v &&
                        (g.foldWidget.style.height = v);
                    } else
                      g.foldWidget &&
                        (g.element.removeChild(g.foldWidget),
                        (g.foldWidget = null));
                    var w = (u = d ? d.getText(t, p) : p + h);
                    w != g.textNode.data && (g.textNode.data = w), p++;
                  }
                  (this.element.style.height = e.minHeight + "px"),
                    (this.$fixedWidth || t.$useWrapMode) &&
                      (u = t.getLength() + h);
                  var C = d
                      ? d.getWidth(t, u, e)
            ...
            (function () {
              (this.$padding = 0),
                  ...
                  if (e) {
                    ...
                    for (var i in this.markers) {
                      ...
                      if (n.range) {
                        ...
                        if (!o.isEmpty())
                          if (
                            ((o = o.toScreenRange(this.session)), n.renderer)
                          ) {
                            var r = this.$getTop(o.start.row, e),
                              s =
                                this.$padding +
                                o.start.column * e.characterWidth;
                            n.renderer(t, o, s, r, e);
                          } else
                            "fullLine" == n.type
                              ? this.drawFullLineMarker(t, o, n.clazz, e)
                              : "screenLine" == n.type
                                ? this.drawScreenLineMarker(t, o, n.clazz, e)
                                : o.isMultiLine()
                                  ? "text" == n.type
                                    ? this.drawTextMarker(t, o, n.clazz, e)
                                    : this.drawMultiLineMarker(t, o, n.clazz, e)
                ...
                (this.drawTextMarker = function (e, t, i, o, r) {
                  var s = t.start.row,
                    a = new n(
                      ...
                      t.start.column,
                      s,
                      this.session.getScreenLastRowColumn(s),
                    );
                  for (
                    this.drawSingleLineMarker(e, a, i + " ace_start", o, 1, r),
                      s = t.end.row,
                      a = new n(s, 0, s, t.end.column),
                      this.drawSingleLineMarker(e, a, i, o, 0, r),
                      s = t.start.row + 1;
                    s < t.end.row;
                    s++
                  )
                    (a.start.row = s),
                      (a.end.row = s),
                      (a.end.column = this.session.getScreenLastRowColumn(s)),
                      this.drawSingleLineMarker(e, a, i, o, 1, r);
                }),
                ...
                (this.drawSingleLineMarker = function (e, t, i, n, o, r) {
                  var s = n.lineHeight,
                    a =
                      (t.end.column + (o || 0) - t.start.column) *
                      n.characterWidth,
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            var n = e("../lib/oop"),
              ...
              r = e("../lib/lang"),
              s =
                (e("../lib/useragent"), e("../lib/event_emitter").EventEmitter),
              a = function (e) {
                (this.element = o.createElement("div")),
            ...
            (function () {
              n.implement(this, s),
                    ...
                    if (this.displayIndentGuides) {
                      ...
                      if (this.showInvisibles) {
                        ...
                        var a = r.stringRepeat(this.SPACE_CHAR, this.tabSize),
                          l =
                            this.TAB_CHAR +
                            r.stringRepeat(" ", this.tabSize - 1);
                      } else
                        var a = r.stringRepeat(" ", this.tabSize),
                          l = a;
                      (this.$tabStrings[" "] =
                        "<span class='" + n + o + "'>" + a + "</span>"),
                        (this.$tabStrings["	"] =
                          "<span class='" + n + s + "'>" + l + "</span>");
                    }
                  }),
                (this.updateLines = function (e, t, i) {
                  ...
                  for (
                    var a = n,
                      l = this.session.getNextFoldLine(a),
                      c = l ? l.start.row : 1 / 0;
                    ;
                    ...
                    if (h) {
                      ...
                      this.$renderLine(
                        ...
                        (h.style.height =
                          e.lineHeight * this.session.getRowLength(a) + "px"),
                        (h.innerHTML = u.join(""));
                    }
                    a++;
                  }
                ...
                (this.scrollLines = function (e) {
                  ...
                  if (t.firstRow < e.firstRow)
                    for (
                      var n = this.session.getFoldedRowCount(
                        t.firstRow,
                        e.firstRow - 1,
                      );
                      n > 0;
                  ...
                  if (e.firstRow < t.firstRow) {
                    var o = this.$renderLinesFragment(
                      e,
                      e.firstRow,
                      t.firstRow - 1,
                    );
                ...
                (this.$renderLinesFragment = function (e, t, i) {
                  for (
                    var n = this.element.ownerDocument.createDocumentFragment(),
                      r = t,
                      s = this.session.getNextFoldLine(r),
                      a = s ? s.start.row : 1 / 0;
                    ;
                  ...
                  for (
                    ...
                    this.$useLineGroups() &&
                      t.push(
                        ...
                        e.lineHeight * this.session.getRowLength(o),
                        "px'>",
                      ),
                ...
                (this.$renderToken = function (e, t, i, n) {
                  var o = this,
                    ...
                    a = function (e, i, n, s, a) {
                      if (i)
                        return o.showInvisibles
                          ? "<span class='ace_invisible ace_invisible_space'>" +
                              r.stringRepeat(o.SPACE_CHAR, e.length) +
                              "</span>"
                  ...
                  return 0 >= n || n >= i
                    ...
                    : " " == t[0]
                      ? ((n -= n % this.tabSize),
                        ...
                        t.substr(n))
                      : "	" == t[0]
                        ? (e.push(r.stringRepeat(this.$tabStrings["	"], n)),
                          t.substr(n))
                        : t;
                }),
                (this.$renderWrappedLine = function (e, t, i, n) {
                  for (
                    var o = 0, r = 0, s = i[0], a = 0, l = 0;
                    l < t.length;
                    l++
                  ) {
                    var c = t[l],
                    ...
                    if (0 == l && this.displayIndentGuides) {
                      if (
                        ((o = h.length),
                        (h = this.renderIndentGuide(e, h, s)),
                        !h)
                      )
                        continue;
                      o -= h.length;
                    ...
                    if (o + h.length < s)
                      ...
                      for (; o + h.length >= s; )
                        (a = this.$renderToken(e, a, c, h.substring(0, s - o))),
                          (h = h.substring(s - o)),
                          (o = s),
                          n ||
                            e.push(
                          ...
                          r++,
                          (a = 0),
                          (s = i[r] || Number.MAX_VALUE);
                      0 != h.length &&
                        ((o += h.length), (a = this.$renderToken(e, a, c, h)));
                    }
                  }
                }),
                ...
                (this.$renderLine = function (e, t, i, n) {
                  ...
                  if (
                    ...
                    r && r.length
                      ? this.$renderWrappedLine(e, o, r, i)
                      : this.$renderSimpleLine(e, o);
                  }
                  this.showInvisibles &&
                    (n && (t = n.end.row),
                    e.push(
                ...
                (this.$getFoldLineTokens = function (e, t) {
                  function i(e, t, i) {
                    ...
                    for (; i > r && n < e.length; ) {
                      ...
                      o.push(
                        s.length + r > i
                          ? { type: e[n].type, value: s.substring(0, i - r) }
                          : e[n],
                      ),
                        (r += s.length),
                        (n += 1);
            ...
            var n,
              ...
              r = function (e) {
                (this.element = o.createElement("div")),
                  ...
                  e.appendChild(this.element),
                  void 0 === n && (n = "opacity" in this.element),
                  (this.isVisible = !1),
                  (this.isBlinking = !0),
              ...
              (this.$updateVisibility = function (e) {
                ...
                (this.restartTimer = function () {
                  ...
                  if (
                    ...
                    this.smoothBlinking &&
                      o.removeCssClass(this.element, "ace_smooth-blinking"),
                    e(!0),
                ...
                (this.getPixelPosition = function (e, t) {
                  ...
                  var i = this.session.documentToScreenPosition(e),
                    ...
                    o =
                      (i.row - (t ? this.config.firstRowScreen : 0)) *
                      this.config.lineHeight;
                  return { left: n, top: o };
                }),
                (this.update = function (e) {
                  ...
                  for (var i = 0, o = t.length; o > i; i++) {
                    ...
                    if (
                      !((r.top > e.height + e.offset || r.top < 0) && i > 1)
                    ) {
                ...
                (this.$setOverwrite = function (e) {
                  e != this.overwrite &&
                    ((this.overwrite = e),
                    e
                      ? o.addCssClass(this.element, "ace_overwrite-cursors")
                      : o.removeCssClass(
                          this.element,
            ...
            var l = function (e, t) {
              a.call(this, e),
                ...
                (t.$scrollbarWidth = this.width =
                  o.scrollbarWidth(e.ownerDocument)),
          ...
          function (e, t, i) {
            ...
            var v = function (e, t) {
              ...
              (this.canvas = n.element),
                ...
                (this.$fontMetrics = new f(this.container, 500)),
              ...
              (this.CHANGE_CURSOR = 1),
                  ...
                  if (this.$keepTextAreaAtCursor) {
                    ...
                    if (!(0 > t || t > e.height - n)) {
                      ...
                      if (this.$composition) {
                        ...
                        (o *= this.session.$getStringScreenWidth(r)[0] + 2),
                          (n += 2);
                      }
                      (i -= this.scrollLeft),
                        ...
                        (this.textarea.style.left =
                          Math.min(i, this.$size.scrollerWidth - o) + "px"),
                        (this.textarea.style.top =
                          Math.min(t, this.$size.height - n) + "px");
                    }
                  }
                }),
                (this.getFirstVisibleRow = function () {
                ...
                (this.setScrollMargin = function (e, t, i, n) {
                  ...
                  (o.top = 0 | e),
                    ...
                    o.top &&
                      this.scrollTop <= 0 &&
                      this.session &&
                      this.session.setScrollTop(-o.top),
                    this.updateFull();
                }),
                ...
                (this.$autosize = function () {
                  ...
                  if (
                    ...
                    n != this.$vScroll &&
                      ((this.$vScroll = n), this.scrollBarV.setVisible(n));
                ...
                (this.$computeLayerConfig = function () {
                  ...
                  var e = this.session,
                    ...
                    l =
                      ...
                      (this.$hScrollBarAlwaysVisible ||
                        t.scrollerWidth - a - 2 * this.$padding < 0),
                  ...
                  (o += h),
                    this.session.setScrollTop(
                      Math.max(
                        ...
                        Math.min(
                          this.scrollTop,
                          o - t.scrollerHeight + this.scrollMargin.bottom,
                        ),
                      ),
                    ),
                  ...
                  var u =
                      ...
                      (this.$vScrollBarAlwaysVisible ||
                        t.scrollerHeight - o + h < 0 ||
                        this.scrollTop),
                    d = this.$vScroll !== u;
                  d && ((this.$vScroll = u), this.scrollBarV.setVisible(u));
                  var g,
                    f,
                    p = Math.ceil(s / this.lineHeight) - 1,
                    m = Math.max(
                      0,
                  ...
                  w && (m = w.start.row),
                    (g = e.documentToScreenRow(m, 0)),
                    (f = e.getRowLength(m) * A),
                    (v = Math.min(
                      e.screenToDocumentRow(v, 0),
                      e.getLength() - 1,
                    )),
                    (s = t.scrollerHeight + e.getRowLength(v) * A + f),
                    (r = this.scrollTop - g * A);
                  var C = 0;
                  return (
                    this.layerConfig.width != a && (C = this.CHANGE_H_SCROLL),
                    (c || d) &&
                      ((C = this.$updateCachedSize(
                        !0,
                        this.gutterWidth,
                        t.width,
                        t.height,
                    ...
                    (this.layerConfig = {
                      ...
                      gutterOffset: Math.max(
                        0,
                        Math.ceil((r + t.height - t.scrollerHeight) / A),
                      ),
                ...
                (this.$updateLines = function () {
                  ...
                  var i = this.layerConfig;
                  return e > i.lastRow + 1 || t < i.firstRow
                    ? void 0
                    : t === 1 / 0
                      ? (this.$showGutter && this.$gutterLayer.update(i),
                  ...
                  if (0 !== this.$size.scrollerHeight) {
                    var n = this.$cursorLayer.getPixelPosition(e),
                      ...
                      l = this.$scrollAnimation
                        ...
                        : this.scrollTop;
                    l + s > r
                      ? (t && (r -= t * this.$size.scrollerHeight),
                        0 === r && (r = -this.scrollMargin.top),
                        this.session.setScrollTop(r))
                      : l + this.$size.scrollerHeight - a <
                          r + this.lineHeight &&
                        (t && (r += t * this.$size.scrollerHeight),
                        this.session.setScrollTop(
                    ...
                    c > o
                      ? (o <
                          this.$padding + 2 * this.layerConfig.characterWidth &&
                          (o = -this.scrollMargin.left),
                        this.session.setScrollLeft(o))
                      : c + this.$size.scrollerWidth < o + this.characterWidth
                        ? this.session.setScrollLeft(
                            Math.round(
                              o +
                                this.characterWidth -
                ...
                (this.scrollBy = function (e, t) {
                  t &&
                    this.session.setScrollTop(this.session.getScrollTop() + t),
                    e &&
                      this.session.setScrollLeft(
                ...
                (this.pixelToScreenCoordinates = function (e, t) {
                  var i = this.scroller.getBoundingClientRect(),
                    n =
                      ...
                      this.characterWidth,
                    o = Math.floor(
                      (t + this.scrollTop - i.top) / this.lineHeight,
                    ),
                    r = Math.round(n);
                ...
                (this.hideComposition = function () {
                  this.$composition &&
                    (o.removeCssClass(this.textarea, "ace_composition"),
                  ...
                  function i(i) {
                    ...
                    if (i.cssClass) {
                      o.importCssString(
                        ...
                        n.theme &&
                          o.removeCssClass(n.container, n.theme.cssClass);
                      var r =
                        "padding" in i
                          ? i.padding
                          : "padding" in (n.theme || {})
                ...
                highlightGutterLine: {
                  set: function (e) {
                    return this.$gutterLineHighlight
                      ...
                      : ((this.$gutterLineHighlight = o.createElement("div")),
          ...
          function (e, t, n) {
            ...
            var o = e("../lib/oop"),
              ...
              l = function (t, n, o, r) {
                ...
                try {
                  var c = n.src,
                    h = i(19),
                    u = new h([c], { type: "application/javascript" }),
            ...
            var c = function (e, t, i) {
              ...
              var c = function () {
                ...
                e.command
                  ? n[e.command].apply(n, e.args)
                  : e.event && r._signal(e.event, e.data);
              };
                        ...
                        if ("insertText" === t.action)
                          ...
                          for (var s = this.others.length - 1; s >= 0; s--) {
                            ...
                            a.row === i.start.row &&
                              ...
                              (l.column += o),
                              this.doc.remove(
                                new n(l.row, l.column, l.row, l.column - o),
                              );
                          }
                        i.start.column === this.pos.column &&
                        "insertText" === t.action
                          ? setTimeout(
                              function () {
                                ...
                                for (var e = 0; e < this.others.length; e++) {
                                  var t = this.others[e],
                                    n = { row: t.row, column: t.column - o };
                                  t.row === i.start.row &&
                                    i.start.column < t.column &&
                                    (n.column += o),
                                    t.setPosition(n.row, n.column);
                                }
                              }.bind(this),
                              0,
                            )
                            ...
                            setTimeout(
                              function () {
                                for (var e = 0; e < this.others.length; e++) {
                                  ...
                                  t.row === i.start.row &&
                                    i.start.column < t.column &&
                                    t.setPosition(t.row, t.column - o);
                                }
                              }.bind(this),
                              0,
                            );
            ...
            function o(e) {
              ...
              if (0 === c) {
                var h,
                  ...
                  C = u.session,
                  E = u.renderer.pixelToScreenCoordinates(v, A),
                  F = E;
                ...
                if (
                  ...
                  u.$blockScrolling++,
                    ...
                    o &&
                      ((b = null),
                      (y = d.ranges[0]),
                      u.removeSelectionMarker(y)),
                    u.once("mouseup", function () {
                      var e = d.toOrientedRange();
                      b && e.isEmpty() && n(b.cursor, e.cursor)
                        ? d.substractPoint(e.cursor)
                        : (o
                            ? d.substractPoint(y.cursor)
                            : y && (u.removeSelectionMarker(y), d.addRange(y)),
                          d.addRange(e)),
                        u.$blockScrolling--,
                  ...
                  var x,
                    S = [],
                    $ = function () {
                      var e = u.renderer.pixelToScreenCoordinates(v, A),
                        t = C.screenToDocumentPosition(e.row, e.column);
                      (n(F, e) && n(t, d.lead)) ||
                        ((F = e),
                        u.selection.moveToPosition(t),
                        u.renderer.scrollCursorIntoView(),
                        u.removeSelectionMarkers(S),
                        (S = d.rectangularRangeBlock(F, E)),
                        u.$mouseHandler.$clickSelection &&
                          1 == S.length &&
                          S[0].isEmpty() &&
                          (S[0] = u.$mouseHandler.$clickSelection.clone()),
                        S.forEach(u.addSelectionMarker, u),
                  ...
                  g && !l
                    ...
                    : !g &&
                      l &&
                      ((x = d.toOrientedRange()), u.addSelectionMarker(x)),
                    o
                      ? (E = C.documentToScreenPosition(d.lead))
                      : d.moveToPosition(f),
                    (F = { row: -1, column: -1 });
                  var B = function (e) {
                      clearInterval(k),
          ...
          function (e, t, i) {
            ...
            function s(e) {
              ...
              u.addListener(i, "keydown", function (i) {
                18 != i.keyCode || i.ctrlKey || i.shiftKey || i.metaKey
                  ? n && t()
              ...
              function () {
                (this.ranges = null),
                      ...
                      if (o == r) {
                        if (n)
                          ...
                          var s = i.start,
                            a = i.end;
                        return (
                          this.addRange(l.fromPoints(a, a)),
                  ...
                  (this.rectangularRangeBlock = function (e, t, i) {
                    ...
                    for (var d = h; u >= d; d++) {
                      var g = l.fromPoints(
                        this.session.screenToDocumentPosition(d, s),
            ...
            (function () {
              (this.updateSelectionMarkers = function () {
                ...
                (this.removeSelectionMarkers = function (e) {
                  for (
                    var t = this.session.$selectionMarkers, i = e.length;
                    i--;
                ...
                (this.forEachSelection = function (e, t, i) {
                  if (!this.inVirtualSelectionMode) {
                    ...
                    return (
                      ...
                      p &&
                        p.from == p.to &&
                        this.renderer.animateScrolling(p.from),
                      n
                    );
                  }
                }),
                ...
                (this.selectMoreLines = function (e, t) {
                  ...
                  var r = this.session.screenToDocumentPosition(
                    o.row + e,
                    o.column,
                  );
                  if (i.isEmpty()) var s = r;
                  else
                    var a = this.session.documentToScreenPosition(
                        n ? i.end : i.start,
                      ),
                ...
                (this.selectMore = function (e, t, i) {
                  ...
                  if (
                    !s.isEmpty() ||
                    ((s = o.getWordRange(s.start.row, s.start.column)),
                  ...
                  if (i.length && o.length != i.length - 1) {
                    ...
                    i.forEach(function (t, i) {
                      var n = t.cursor,
                        ...
                        c = a[i] - s;
                      o > c
                        ? e.insert(n, d.stringRepeat(" ", o - c))
                        : e.remove(
                            new l(n.row, n.column, n.row, n.column - o + c),
                          ),
                    ...
                    if (g) {
                      ...
                      while (/[=:]/.test(f) && ++u < p);
                      do f = this.session.getLine(h);
                      while (/[=:]/.test(f) && --h > 0);
                      0 > h && (h = 0), u >= p && (u = p - 1);
                    }
                    var m = this.session.doc.removeLines(h, u);
                    (m = this.$reAlignText(m, g)),
                      ...
                      return t
                        ? null == s
                          ? ((s = t[1].length),
                            ...
                            t)
                          : (s + a + l !=
                              t[1].length + t[2].length + t[3].length &&
                              (h = !1),
                            s != t[1].length && (c = !1),
              ...
              (t.onSessionChange = function (e) {
                ...
                i &&
                  ...
                  i.multiSelect.lead.off(
                    "change",
                    this.$checkMultiselectChange,
                  ),
                  i.multiSelect.anchor.off(
                    "change",
                    this.$checkMultiselectChange,
                  )),
                  t &&
            ...
            (function () {
              (this.foldingStartMarker = null),
                ...
                (this.indentationBlock = function (e, t, i) {
                  ...
                  if (-1 != s) {
                    for (
                      var a = i || r.length, l = e.getLength(), c = t, h = t;
                      ++t < l;
                ...
                (this.closingBracketBlock = function (e, t, i, o, r) {
                  var s = { row: i, column: o },
                    a = e.$findOpeningBracket(t, s);
                  return a
                    ? (a.column++, s.column--, n.fromPoints(a, s))
                    : void 0;
                });
            }).call(o.prototype);
          },
            ...
            (function () {
              (this.getRowLength = function (e) {
                ...
                (this.removeLineWidget = function (e) {
                  ...
                  this.session.lineWidgets &&
                    (this.session.lineWidgets[e.row] = void 0),
                    this.session._emit("changeFold", {
                      data: { start: { row: e.row } },
                    }),
                    this.$updateRows();
                ...
                (this.measureWidgets = function (e, t) {
                  ...
                  if (i && i.length) {
                    for (var o = 1 / 0, r = 0; r < i.length; r++) {
                      ...
                      s.coverLine &&
                        ((a -= this.session.getRowLineCount(s.row)),
                        0 > a && (a = 0)),
                        s.rowCount != a &&
                          ((s.rowCount = a), s.row < o && (o = s.row));
                    }
                    o != 1 / 0 &&
                      (this.session._emit("changeFold", {
                        data: { start: { row: o } },
                ...
                (this.renderWidgets = function (e, t) {
                  ...
                  if (n) {
                    for (
                      var o = Math.min(this.firstRow, i.firstRow),
                    ...
                    for (var s = o; r >= s; s++) {
                      ...
                      if (a && a.el) {
                        ...
                        a.coverLine ||
                          (l +=
                            i.lineHeight * this.session.getRowLineCount(a.row)),
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            function o(e, t, i) {
              ...
              if (o.length) {
                ...
                if (s && i) {
                  ...
                  var l = [];
                  t = s.row;
                  do l[0 > i ? "unshift" : "push"](s), (s = o[(r += i)]);
                  while (s && s.row == t);
                  return l.length && l;
                }
              }
            ...
            (t.showErrorMarker = function (e, t) {
              var i = e.session;
              i.widgetManager ||
                ((i.widgetManager = new r(i)), i.widgetManager.attach(e));
              ...
              (f.style.left = p + e.renderer.gutterWidth - 5 + "px"),
                (d.el.className = "error_widget_wrapper"),
                (g.className = "error_widget " + c.className),
                (g.innerHTML = c.text.join("<br>")),
                g.appendChild(s.createElement("div"));
              var m = function (e, t, i) {
                return 0 !== t || ("esc" !== i && "return" !== i)
                  ? void 0
                  : (d.destroy(), { command: "null" });
              };
              (d.destroy = function () {
              ...
              (t.edit = function (e) {
                ...
                return (
                  ...
                  h.on("destroy", function () {
                    o.removeListener(window, "resize", u.onResize),
                      (u.editor.container.env = null);
                  }),
                  (h.container.env = h.env = u),
                  h
                );
              }),
            ...
            (function () {
              (this.checkOutdent = function (e, t) {
                ...
                (this.autoOutdent = function (e, t) {
                  ...
                  if (!o) return 0;
                  var r = o[1].length,
                    s = e.findMatchingBracket({ row: t, column: r });
                ...
                this.add("braces", "insertion", function (e, t, i, o, r) {
                  ...
                  if ("{" == r) {
                    ...
                    if ("" !== h && "{" !== h && i.getWrapBehavioursEnabled())
                      return { text: "{" + h + "}", selection: !1 };
                    if (d.isSaneInsertion(i, o))
                      return /[\]\}\)]/.test(l[s.column]) || i.inMultiSelectMode
                        ? (d.recordAutoInsert(i, o, "}"),
                          { text: "{}", selection: [1, 1] })
                        : (d.recordMaybeInsert(i, o, "{"),
                          { text: "{", selection: [1, 1] });
                  } else if ("}" == r) {
                    u(i);
                    ...
                    if ("}" == g) {
                      ...
                      if (null !== f && d.isAutoInsertedClosing(s, l, r))
                        return (
                  ...
                  this.add("parens", "insertion", function (e, t, i, n, o) {
                    if ("(" == o) {
                      ...
                      if (d.isSaneInsertion(i, n))
                        return (
                          d.recordAutoInsert(i, n, ")"),
                          { text: "()", selection: [1, 1] }
                        );
                    } else if (")" == o) {
                      u(i);
                      ...
                      if (")" == c) {
                        ...
                        if (null !== h && d.isAutoInsertedClosing(a, l, o))
                          return (
                            d.popAutoInsertedClosing(),
                            { text: "", selection: [1, 1] }
                          );
                    ...
                    function (e, t, i, n, o) {
                      if ('"' == o || "'" == o) {
                        ...
                        for (
                          ...
                          "string" == g.type
                            ? (m = -1)
                            : 0 > m && (m = g.value.indexOf(r)),
                          !(g.value.length + p > s.start.column));
                          v++
                        )
                          p += f[v].value.length;
                        if (
                          ...
                          (0 > m &&
                            "comment" !== g.type &&
                            ("string" !== g.type ||
                              (s.start.column !== g.value.length + p - 1 &&
            ...
            (d.isSaneInsertion = function (e, t) {
              ...
              return (
                ...
                n.getCurrentTokenRow() !== i.row ||
                  this.$matchTokenType(n.getCurrentToken() || "text", c)
              );
            }),
              ...
              (d.recordAutoInsert = function (e, t, i) {
                ...
                this.isAutoInsertedClosing(o, r, n.autoInsertedLineEnd[0]) ||
                  ...
                  (this.getFoldWidgetRange = function (e, t, i, n) {
                    ...
                    if ("markbegin" !== t) {
                      ...
                      if (r) {
                        ...
                        return r[1]
                          ? this.closingBracketBlock(e, r[1], i, s)
        ...
        function i() {
          ...
          return function (e, t) {
            var n = new i(),
              o = t.endings,
              r = t.type;
            if (o) for (var s = 0, a = e.length; a > s; ++s) n.append(e[s], o);
            else for (var s = 0, a = e.length; a > s; ++s) n.append(e[s]);
