          ...
          r.addListener(n, "blur", function (e) {
            ...
            (this.focus = function () {
              ...
              (n.style.position = "fixed"),
                ...
                setTimeout(function () {
                  (n.style.position = ""),
                    n.style.top == "-1000px" && (n.style.top = e);
                }, 0);
            }),
            (this.blur = function () {
              n.blur();
      ...
      (function () {
        ...
        (this.execute = function (e) {
          ...
          (this.undo = function (e) {
            ...
            return (
              t &&
                ((n = this.$doc.undoChanges(this.$deserializeDeltas(t), e)),
              ...
              if (!this.session.$fromUndo) {
                if (e.action === "insert")
                  for (var s = this.others.length - 1; s >= 0; s--) {
                    ...
                    o.row === t.start.row &&
                      t.start.column < o.column &&
                      (u.column += n),
                      this.doc.insertMergedLines(u, e.lines);
                  }
                else if (e.action === "remove")
                  for (var s = this.others.length - 1; s >= 0; s--) {
                    var o = this.others[s],
                    ...
                    o.row === t.start.row &&
                      ...
                      (u.column += n),
                      this.doc.remove(
                        new r(u.row, u.column, u.row, u.column - n),
                      );
                  }
                    ...
                    setTimeout(
                      function () {
                        for (var e = 0; e < this.others.length; e++) {
                          ...
                          r.row === t.start.row &&
                            t.start.column < r.column &&
                            r.setPosition(r.row, r.column - n);
                        }
                      }.bind(this),
                      0,
                    );
