"""Helper for updating a projectum's log_url Log_urls are the google doc links
to a projectum's Projectum Agenda Log."""
...
class LogUrlUpdaterHelper(DbHelperBase):
    """Update a projectum's Log_url, will add a new Log_URL if one doesn't yet
    exist."""
