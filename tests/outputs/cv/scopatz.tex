...
Omega Laser User's Group Travel Award (\$1,100)\dotfill & \hspace{.1in} 
&2013\\

NIF User's Group Travel Award (\$1,150)\dotfill & \hspace{.1in} 
&2013\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{itemize}[label=$-$]
        ...
        \item   Anthony Scopatz\textemdash Associate Scientist, 
...
\item Anthony Scopatz, {\bf Nanostructure challenges and successes from 
...
\item Anthony Scopatz, {\bf Clustermining: extracting core structures of 
metallic nanoparticles from the atomic pair distribution function},
