...
@pytest.mark.parametrize(
    "input,expected",
    [([2019, 1, 15], 2019.0115), ([2019, "May", 0], 2019.05), ([2019, "February", 2], 2019.0202)],
)
...
@pytest.mark.parametrize(
    "input,flag,expected",
    [
        ([(date(2020, 1, 1), date(2020, 1, 31)), (date(2020, 2, 1), date(2020, 2, 5))], False, True),
        ([(date(2020, 2, 1), date(2020, 2, 5)), (date(2020, 1, 1), date(2020, 1, 31))], False, True),
        ([(date(2020, 1, 1), date(2020, 1, 31)), (date(2020, 2, 2), date(2020, 2, 5))], False, False),
        ([(date(2020, 1, 1), date(2020, 1, 31)), (date(2020, 1, 31), date(2020, 2, 5))], False, False),
        ([(date(2020, 1, 1), date(2020, 1, 31)), (date(2020, 1, 31), date(2020, 2, 5))], True, True),
        (
            [
                (date(2020, 1, 1), date(2020, 1, 31)),
                (date(2020, 2, 1), date(2020, 2, 5)),
                (date(2020, 2, 6), date(2020, 2, 7)),
            ],
            False,
            True,
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ({"year": 2020}, None),
            {"begin_date": datetime.date(2020, 1, 1), "end_date": datetime.date(2020, 12, 31)},
        ),
        (
            ({"year": 2020, "month": 9}, None),
            {"begin_date": datetime.date(2020, 9, 1), "end_date": datetime.date(2020, 9, 30)},
        ),
        (({}, None), {}),
        (({"year": "tbd", "month": 9}, None), {}),
        (
            ({"year": 2019, "month": "tbd"}, None),
            {"begin_date": datetime.date(2019, 1, 1), "end_date": datetime.date(2019, 12, 31)},
        ),
        (
            ({"year": 2020, "month": 9}, None),
            {"begin_date": datetime.date(2020, 9, 1), "end_date": datetime.date(2020, 9, 30)},
        ...
        (({"begin_year": 2020}, None), {"begin_date": datetime.date(2020, 1, 1)}),
        (({"begin_year": 2020, "begin_month": 4}, None), {"begin_date": datetime.date(2020, 4, 1)}),
        (
        ...
        (
            ...
            {"begin_date": datetime.date(2019, 1, 1), "end_date": datetime.date(2020, 12, 31)},
        ),
        (
            ({"begin_year": 2019, "end_year": 2020, "end_month": "Feb"}, None),
            {"begin_date": datetime.date(2019, 1, 1), "end_date": datetime.date(2020, 2, 29)},
        ),
        (
            ({"begin_year": 2019, "end_year": 2020, "end_month": "Feb", "end_day": 10}, None),
            {"begin_date": datetime.date(2019, 1, 1), "end_date": datetime.date(2020, 2, 10)},
        ),
        (
            (
                {
                    "begin_date": "2020-05-09",
                    "begin_year": 2019,
                    "end_year": 2020,
                    "end_month": "Feb",
                    "end_day": 10,
            ...
            {"begin_date": datetime.date(2020, 5, 9), "end_date": datetime.date(2020, 2, 10)},
        ),
        (
            (
                {"end_date": "2020-5-20", "begin_year": 2019, "end_year": 2020, "end_month": "Feb", "end_day": 10},
                None,
            ),
            {"begin_date": datetime.date(2019, 1, 1), "end_date": datetime.date(2020, 5, 20)},
        ),
        (
            ({"date": "2020-5-20", "begin_year": 2019, "end_year": 2020, "end_month": "Feb", "end_day": 10}, None),
            {
        ...
        (
            ({"submission_day": 10, "submission_year": 2020, "submission_month": "Feb"}, "submission"),
            {
        ...
        (
            ({"year": 2020, "submission_year": 2019}, "submission"),
            {"begin_date": datetime.date(2019, 1, 1), "end_date": datetime.date(2019, 12, 31)},
        ),
    ],
)
...
@pytest.mark.parametrize("year,month,expected", [(2020, 2, 29), (2020, "Feb", 29)])
