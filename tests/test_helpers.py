...
helper_map = [
    ...
    (["helper", "a_proposal", "an empty new proposal","100.0","To understand numbers"],
    "20_an_empty_new_proposal has been added in proposals\n"),
    (["helper", "a_proposal", "a sparse new proposal","500.0","To destroy numbers",
      "-a", "-c", "-p", "--cppflag", "--other_agencies", "-i",
      "--months_academic", "--months_summer", "-s", "-f", "-n", "this is a minimal proposal"],
     "20_a_sparse_new_proposal has been added in proposals\n"),
