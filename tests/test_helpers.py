...
helper_map = [
    ...
    (["helper", "a_proposal", "a new proposal", 500.0, "Kurt Godel", "USD"
      "2022-12-14", "3", "2021-04-09", "Simon Billinge", "To destroy numbers"
      "-b", "2020-09-22", "-e", "2022-12-31", "-f", "Columbia"],
     "21_a_new_proposal has been added in proposals\n"),
