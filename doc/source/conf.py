...
# -*- coding: utf-8 -*-
#
# regro documentation build configuration file, created by
...
basename = "regro".replace(" ", "").replace(".", "")
...
latex_documents = [
    ("index", "regro.tex", "regro Documentation", ab_authors, "manual"),
]
...
man_pages = [("index", "regro", "regro Documentation", ab_authors, 1)]
